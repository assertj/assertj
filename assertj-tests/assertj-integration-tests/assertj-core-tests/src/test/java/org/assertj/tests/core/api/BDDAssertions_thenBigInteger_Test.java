...
import static org.assertj.core.api.BDDAssertions.thenBigInteger;
...
class BDDAssertions_thenBigInteger_Test {
  ...
  void should_accept_BigInteger() {
    ...
    // WHEN
    AbstractBigIntegerAssert<?> result = thenBigInteger(actual);
    // THEN
  ...
  void should_accept_bounded_generic_BigInteger_subtype() {
    // WHEN
    AbstractBigIntegerAssert<?> result = thenBigInteger(getBigIntegerSubtype());
    // THEN
    result.isNotNull();
  }
