...
class Assertions_assertThatIllegalArgumentException_Test {
  ...
  void should_pass_if_IllegalArgumentException_is_thrown() {
    ...
    // WHEN/THEN
    assertThatIllegalArgumentException().isThrownBy(throwingSupplier).withMessage("boom");
  }
  ...
  void should_fail_if_IllegalArgumentException_is_not_thrown() {
    ...
    // WHEN
    AssertionError assertionError = expectAssertionError(() -> assertThatIllegalArgumentException().isThrownBy(throwingSupplier));
    // THEN
