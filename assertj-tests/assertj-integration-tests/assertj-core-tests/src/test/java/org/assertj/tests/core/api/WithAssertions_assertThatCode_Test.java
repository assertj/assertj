...
class WithAssertions_assertThatCode_Test {
  ...
  void can_invoke_late_assertion() {
    ...
    // WHEN/THEN
    withAssertions.assertThatCode(boom).isInstanceOf(Exception.class)
  ...
  void should_fail_when_asserting_no_exception_was_thrown_and_an_exception_was_thrown() {
    ...
    // WHEN
    var error = expectAssertionError(() -> withAssertions.assertThatCode(boom).doesNotThrowAnyException());
    // THEN
  ...
  void should_fail_when_asserting_no_exception_was_thrown_except_an_empty_list_and_an_exception_was_thrown() {
    ...
    ThrowingCallable boom = raisingException(exception);
    // WHEN
    var error = expectAssertionError(() -> withAssertions.assertThatCode(boom).doesNotThrowAnyExceptionExcept());
    // THEN
  ...
  void should_fail_when_asserting_no_exception_was_thrown_except_some_and_a_non_ignored_exception_was_thrown() {
    ...
    ThrowingCallable boom = raisingException(exception);
    // WHEN
    var error = expectAssertionError(() -> withAssertions.assertThatCode(boom)
                                                         .doesNotThrowAnyExceptionExcept(IllegalStateException.class,
                                                                                         IOException.class));
    // THEN
  ...
  void can_use_description_in_error_message() {
    ...
    ThrowingCallable boom = raisingException("boom");
    // WHEN
    var error = expectAssertionError(() -> withAssertions.assertThatCode(boom).as("Test").doesNotThrowAnyException());
    // THEN
  ...
  void error_message_contains_stacktrace() {
    ...
    then(error).hasMessageContainingAll("java.lang.Exception: boom",
                                        "at org.assertj.tests.core/org.assertj.tests.core.api.WithAssertions_assertThatCode_Test.error_message_contains_stacktrace");
  }
  ...
  void should_succeed_when_asserting_no_exception_was_thrown() {
    ...
    // WHEN/THEN
    withAssertions.assertThatCode(silent).doesNotThrowAnyException();
  }
  ...
  void should_succeed_when_asserting_no_exception_was_thrown_except_an_empty_list() {
    ...
    ThrowingCallable silent = () -> {};
    // WHEN/THEN
    withAssertions.assertThatCode(silent).doesNotThrowAnyExceptionExcept();
  }
  ...
  void should_succeed_when_asserting_no_exception_was_thrown_except_some() {
    ...
    ThrowingCallable silent = () -> {};
    // WHEN/THEN
    withAssertions.assertThatCode(silent).doesNotThrowAnyExceptionExcept(IOException.class, IllegalStateException.class);
  }
  ...
  void should_succeed_when_asserting_no_exception_was_thrown_except_one_that_is_an_ignored() {
    ...
    // WHEN/THEN
    withAssertions.assertThatCode(boom).doesNotThrowAnyExceptionExcept(IOException.class, IllegalArgumentException.class);
  }
  ...
  void should_succeed_when_asserting_no_exception_was_thrown_except_one_that_inherits_an_ignored_exception() {
    ...
    ThrowingCallable boom = raisingException(new IllegalArgumentException("boom"));
    // WHEN/THEN
    withAssertions.assertThatCode(boom).doesNotThrowAnyExceptionExcept(RuntimeException.class);
  }
