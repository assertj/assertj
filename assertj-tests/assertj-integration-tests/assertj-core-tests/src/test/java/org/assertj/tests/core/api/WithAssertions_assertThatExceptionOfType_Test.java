...
class WithAssertions_assertThatExceptionOfType_Test {
  ...
  void should_pass_if_expected_exception_is_thrown() {
    ...
    // WHEN/THEN
    withAssertions.assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(throwingSupplier).withMessage("boom");
  }
  ...
  void should_fail_if_expected_exception_is_not_thrown() {
    ...
    // WHEN
    AssertionError assertionError = expectAssertionError(() -> withAssertions.assertThatExceptionOfType(IllegalArgumentException.class)
  ...
  void should_fail_if_no_exception_is_thrown() {
    ...
    AssertionError assertionError = expectAssertionError(() -> withAssertions.assertThatExceptionOfType(IllegalArgumentException.class)
                                                                             .isThrownBy(throwingSupplier));
    // THEN
    then(assertionError).hasMessage("%nExpecting code to throw a java.lang.IllegalArgumentException, but no throwable was thrown.".formatted());
  }
