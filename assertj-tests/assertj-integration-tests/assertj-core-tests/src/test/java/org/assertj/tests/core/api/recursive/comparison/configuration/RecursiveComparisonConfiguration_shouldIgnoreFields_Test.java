...
import org.assertj.tests.core.api.recursive.data.DualValueUtil;
...
class RecursiveComparisonConfiguration_shouldIgnoreFields_Test {
  ...
  private static Stream<Arguments> should_ignore_actual_null_fields() {
    return Stream.of(arguments(DualValueUtil.dualValueWithRandomFieldLocation(null, "John")),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(null, 123)),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(null, null)),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(null, new Date())));
  }
  ...
  private static Stream<Arguments> should_ignore_actual_optional_empty_fields() {
    return Stream.of(arguments(DualValueUtil.dualValueWithRandomFieldLocation(Optional.empty(), "John")),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(Optional.empty(), Optional.of("John"))),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(OptionalInt.empty(), OptionalInt.of(123))),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(OptionalLong.empty(), OptionalLong.of(123L))),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(OptionalDouble.empty(), OptionalDouble.of(123.0))));
  }
  ...
  private static Stream<Arguments> should_ignore_expected_null_fields() {
    return Stream.of(arguments(DualValueUtil.dualValueWithRandomFieldLocation("John", null)),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(123, null)),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(null, null)),
                     arguments(DualValueUtil.dualValueWithRandomFieldLocation(new Date(), null)));
  }
  ...
  void should_be_able_to_ignore_concurrent_types_by_regex(Object value) {
    // GIVEN
    var dualValue = dualValueWithRandomFieldLocation(value, null);
