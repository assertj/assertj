...
class ObjectArrays_assertDoesNotContainNull_Test extends ObjectArraysBaseTest {
  ...
  void should_fail_if_actual_is_null() {
    // WHEN
    AssertionError error = expectAssertionError(() -> arrays.assertDoesNotContainNull(INFO, null));
    // THEN
  ...
  void should_fail_if_actual_is_null_whatever_custom_comparison_strategy_is() {
    // WHEN
    AssertionError error = expectAssertionError(() -> arraysWithCustomComparisonStrategy.assertDoesNotContainNull(INFO, null));
    // THEN
    then(error).hasMessage(actualIsNull());
