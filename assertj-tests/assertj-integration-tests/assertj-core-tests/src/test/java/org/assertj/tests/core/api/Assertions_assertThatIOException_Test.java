...
class Assertions_assertThatIOException_Test {
  ...
  void should_pass_if_IOException_is_thrown() {
    ...
    // WHEN/THEN
    assertThatIOException().isThrownBy(throwingSupplier).withMessage("something was wrong");
  }
  ...
  void should_fail_if_IOException_is_not_thrown() {
    ...
    // WHEN
    AssertionError assertionError = expectAssertionError(() -> assertThatIOException().isThrownBy(throwingSupplier));
    // THEN
