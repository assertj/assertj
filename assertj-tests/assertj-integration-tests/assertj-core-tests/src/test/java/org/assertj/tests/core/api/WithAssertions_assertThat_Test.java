...
class WithAssertions_assertThat_Test {
  ...
  private final WithAssertions underTest = mock(CALLS_REAL_METHODS);
  ...
  void should_accept_AssertDelegateTarget() {
    ...
    // WHEN
    TestAssertDelegateTarget result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_AssertProvider() {
    ...
    // WHEN
    TestAssert result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_AtomicBoolean() {
    ...
    // WHEN
    AtomicBooleanAssert result = underTest.assertThat(actual);
    // THEN
    result.isFalse();
  }
  ...
  void should_accept_AtomicInteger() {
    ...
    // WHEN
    AtomicIntegerAssert result = underTest.assertThat(actual);
    // THEN
    result.hasValue(0);
  }
  ...
  void should_accept_AtomicIntegerArray() {
    ...
    // WHEN
    AtomicIntegerArrayAssert result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_AtomicIntegerFieldUpdater() {
    ...
    // WHEN
    AtomicIntegerFieldUpdaterAssert<UpdaterTarget> result = underTest.assertThat(actual);
    // THEN
    result.isNotNull();
  }
  ...
  void should_accept_AtomicLong() {
    ...
    // WHEN
    AtomicLongAssert result = underTest.assertThat(actual);
    // THEN
    result.hasValue(0L);
  }
  ...
  void should_accept_AtomicLongArray() {
    ...
    // WHEN
    AtomicLongArrayAssert result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_AtomicLongFieldUpdater() {
    ...
    // WHEN
    AtomicLongFieldUpdaterAssert<UpdaterTarget> result = underTest.assertThat(actual);
    // THEN
    result.isNotNull();
  }
  ...
  void should_accept_AtomicMarkableReference() {
    ...
    // WHEN
    AtomicMarkableReferenceAssert<String> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_AtomicReference() {
    ...
    // WHEN
    AtomicReferenceAssert<String> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_AtomicReferenceArray() {
    ...
    // WHEN
    AtomicReferenceArrayAssert<String> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_AtomicReferenceFieldUpdater() {
    ...
    AtomicReferenceFieldUpdater<UpdaterTarget, String> actual = AtomicReferenceFieldUpdater.newUpdater(UpdaterTarget.class,
                                                                                                       ...
                                                                                                       "stringValue");
    // WHEN
    AtomicReferenceFieldUpdaterAssert<String, UpdaterTarget> result = underTest.assertThat(actual);
    // THEN
    result.isNotNull();
  }
  ...
  void should_accept_AtomicStampedReference() {
    ...
    // WHEN
    AtomicStampedReferenceAssert<String> result = underTest.assertThat(actual);
    // THEN
    result.hasReference("Yoda");
  }
  ...
  void should_accept_BigDecimal() {
    ...
    // WHEN
    AbstractBigDecimalAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_BigInteger() {
    ...
    // WHEN
    AbstractBigIntegerAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.isZero();
  }
  ...
  void should_accept_boolean_2d_array() {
    ...
    // WHEN
    Boolean2DArrayAssert result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_boolean_array() {
    ...
    // WHEN
    AbstractBooleanArrayAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_byte_2d_array() {
    ...
    byte[][] actual = { { 0, 1 }, { 2, 3 } };
    // WHEN
    Byte2DArrayAssert result = underTest.assertThat(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_byte_array() {
    ...
    byte[] actual = { 0, 1 };
    // WHEN
    AbstractByteArrayAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.containsExactly(0, 1);
  }
  ...
  void should_accept_char_2d_array() {
    ...
    char[][] actual = { { 'a', 'b' }, { 'c', 'd' } };
    // WHEN
    Char2DArrayAssert result = underTest.assertThat(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_char_array() {
    ...
    char[] actual = { 'a', 'b' };
    // WHEN
    AbstractCharArrayAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_CharSequence() {
    ...
    // WHEN
    AbstractCharSequenceAssert<?, ? extends CharSequence> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_Class() {
    ...
    // WHEN
    AbstractClassAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.isPublic();
  }
  ...
  void should_accept_CompletableFuture() {
    ...
    // WHEN
    CompletableFutureAssert<String> result = underTest.assertThat(actual);
    // THEN
    result.isDone();
  }
  ...
  void should_accept_Date() {
    ...
    // WHEN
    AbstractDateAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_double_2d_array() {
    ...
    // WHEN
    Double2DArrayAssert result = underTest.assertThat(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_double_array() {
    ...
    // WHEN
    AbstractDoubleArrayAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_DoublePredicate() {
    ...
    // WHEN
    DoublePredicateAssert result = underTest.assertThat(actual);
    // THEN
    result.accepts(1.0);
  }
  ...
  void should_accept_DoubleStream() {
    ...
    // WHEN
    ListAssert<Double> result = underTest.assertThat(actual);
    // THEN
    result.contains(1.0);
  }
  ...
  void should_accept_Duration() {
    ...
    // WHEN
    AbstractDurationAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.hasHours(10);
  }
  ...
  void should_accept_File() {
    ...
    // WHEN
    AbstractFileAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.doesNotExist();
  }
  ...
  void should_accept_float_2d_array() {
    ...
    // WHEN
    Float2DArrayAssert result = underTest.assertThat(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_float_array() {
    ...
    // WHEN
    AbstractFloatArrayAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_Future() {
    ...
    // WHEN
    FutureAssert<String> result = underTest.assertThat(actual);
    // THEN
    result.isDone();
  }
  ...
  void should_accept_InputStream() {
    ...
    // WHEN
    AbstractInputStreamAssert<?, ? extends InputStream> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_Instant() {
    ...
    // WHEN
    AbstractInstantAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_int_2d_array() {
    ...
    int[][] actual = { { 0, 1 }, { 2, 3 } };
    // WHEN
    Int2DArrayAssert result = underTest.assertThat(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_int_array() {
    ...
    int[] actual = { 0, 1 };
    // WHEN
    AbstractIntArrayAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.containsExactly(0, 1);
  }
  ...
  void should_accept_IntPredicate() {
    ...
    // WHEN
    IntPredicateAssert result = underTest.assertThat(actual);
    // THEN
    result.accepts(1);
  }
  ...
  void should_accept_IntStream() {
    ...
    // WHEN
    ListAssert<Integer> result = underTest.assertThat(actual);
    // THEN
    result.contains(1);
  }
  ...
  void should_accept_Iterable() {
    ...
    // WHEN
    IterableAssert<String> result = underTest.assertThat(actual);
    // THEN
    result.contains("Yoda");
  }
  ...
  void should_accept_Iterator() {
    ...
    // WHEN
    IteratorAssert<String> result = underTest.assertThat(actual);
    // THEN
    result.hasNext();
  }
  ...
  void should_accept_List() {
    ...
    // WHEN
    ListAssert<String> result = underTest.assertThat(actual);
    // THEN
    result.contains("Yoda");
  }
  ...
  void should_accept_LocalDate() {
    ...
    // WHEN
    AbstractLocalDateAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_LocalDateTime() {
    ...
    // WHEN
    AbstractLocalDateTimeAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_LocalTime() {
    ...
    // WHEN
    AbstractLocalTimeAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_long_2d_array() {
    ...
    // WHEN
    Long2DArrayAssert result = underTest.assertThat(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_long_array() {
    ...
    long[] actual = { 0L, 1L };
    // WHEN
    AbstractLongArrayAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.containsExactly(0L, 1L);
  }
  ...
  void should_accept_LongAdder() {
    ...
    // WHEN
    LongAdderAssert result = underTest.assertThat(actual);
    // THEN
    result.hasValue(0L);
  }
  ...
  void should_accept_LongPredicate() {
    ...
    // WHEN
    LongPredicateAssert result = underTest.assertThat(actual);
    // THEN
    result.accepts(1L);
  }
  ...
  void should_accept_LongStream() {
    ...
    // WHEN
    ListAssert<Long> result = underTest.assertThat(actual);
    // THEN
    result.contains(1L);
  }
  ...
  void should_accept_Map() {
    ...
    // WHEN
    MapAssert<String, String> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_Matcher() {
    ...
    // WHEN
    MatcherAssert result = underTest.assertThat(actual);
    // THEN
    result.matches();
  }
  ...
  void should_accept_object_2d_array() {
    ...
    // WHEN
    Object2DArrayAssert<String> result = underTest.assertThat(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_object_array() {
    ...
    // WHEN
    ObjectArrayAssert<String> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_OffsetDateTime() {
    ...
    // WHEN
    AbstractOffsetDateTimeAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_OffsetTime() {
    ...
    // WHEN
    AbstractOffsetTimeAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_Optional() {
    ...
    // WHEN
    OptionalAssert<String> result = underTest.assertThat(actual);
    // THEN
    result.contains("Yoda");
  }
  ...
  void should_accept_OptionalDouble() {
    ...
    // WHEN
    OptionalDoubleAssert result = underTest.assertThat(actual);
    // THEN
    result.hasValue(1.0);
  }
  ...
  void should_accept_OptionalInt() {
    ...
    // WHEN
    OptionalIntAssert result = underTest.assertThat(actual);
    // THEN
    result.hasValue(1);
  }
  ...
  void should_accept_OptionalLong() {
    ...
    // WHEN
    OptionalLongAssert result = underTest.assertThat(actual);
    // THEN
    result.hasValue(1L);
  }
  ...
  void should_accept_Path() {
    ...
    // WHEN
    AbstractPathAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.doesNotExist();
  }
  ...
  void should_accept_Period() {
    ...
    // WHEN
    AbstractPeriodAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.hasYears(1);
  }
  ...
  void should_accept_Predicate() {
    ...
    // WHEN
    PredicateAssert<String> result = underTest.assertThat(actual);
    // THEN
    result.accepts("Yoda");
  }
  ...
  void should_accept_short_2d_array() {
    ...
    // WHEN
    Short2DArrayAssert result = underTest.assertThat(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_short_array() {
    ...
    // WHEN
    AbstractShortArrayAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_Spliterator() {
    ...
    // WHEN
    SpliteratorAssert<String> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_Throwable() {
    ...
    // WHEN
    AbstractThrowableAssert<?, RuntimeException> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_URI() {
    ...
    // WHEN
    AbstractUriAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_URL() throws MalformedURLException {
    ...
    // WHEN
    AbstractUrlAssert<?> result = underTest.assertThat(actual);
    // THEN
    result.hasHost("localhost");
  }
  ...
  void should_accept_Year() {
    ...
    // WHEN
    AbstractComparableAssert<?, Year> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_YearMonth() {
    ...
    // WHEN
    AbstractYearMonthAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  void should_accept_ZonedDateTime() {
    ...
    // WHEN
    AbstractZonedDateTimeAssert<?> result = underTest.assertThat(actual);
    // THEN
  ...
  private record TestAssertDelegateTarget(boolean value) implements AssertDelegateTarget {
    ...
    void isCompletelyTrue() {
      org.assertj.core.api.Assertions.assertThat(value).isTrue();
    }
  ...
  private static class TestAssert extends AbstractAssert<TestAssert, TestAssertProvider> {
    ...
    TestAssert containsText(String text) {
      org.assertj.core.api.Assertions.assertThat(actual.text).contains(text);
      return this;
    }
