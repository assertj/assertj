...
class BDDAssertions_thenIllegalArgumentException_Test {
  ...
  void should_pass_if_IllegalArgumentException_is_thrown() {
    ...
    // WHEN/THEN
    thenIllegalArgumentException().isThrownBy(throwingSupplier).withMessage("boom");
  }
  ...
  void should_fail_if_IllegalArgumentException_is_not_thrown() {
    ...
    // WHEN
    AssertionError assertionError = expectAssertionError(() -> thenIllegalArgumentException().isThrownBy(throwingSupplier));
    // THEN
