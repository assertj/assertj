...
class WithAssertions_assertThatNullPointerException_Test {
  ...
  void should_pass_if_NullPointerException_is_thrown() {
    ...
    // WHEN/THEN
    withAssertions.assertThatNullPointerException().isThrownBy(throwingSupplier).withMessage("something was wrong");
  }
  ...
  void should_fail_if_NullPointerException_is_not_thrown() {
    ...
    // WHEN
    AssertionError assertionError = expectAssertionError(() -> withAssertions.assertThatNullPointerException()
  ...
  void should_fail_if_no_exception_is_thrown() {
    ...
    AssertionError assertionError = expectAssertionError(() -> withAssertions.assertThatNullPointerException()
                                                                             .isThrownBy(throwingSupplier));
    // THEN
    then(assertionError).hasMessage("%nExpecting code to throw a java.lang.NullPointerException, but no throwable was thrown.".formatted());
  }
