...
class BDDAssertions_then_Test {
  ...
  void should_accept_AssertDelegateTarget() {
    ...
    // WHEN
    TestAssertDelegateTarget result = then(actual);
    // THEN
  ...
  void should_accept_AtomicBoolean() {
    ...
    // WHEN
    AtomicBooleanAssert result = then(actual);
    // THEN
    result.isFalse();
  }
  ...
  void should_accept_AtomicInteger() {
    ...
    // WHEN
    AtomicIntegerAssert result = then(actual);
    // THEN
    result.hasValue(0);
  }
  ...
  void should_accept_AtomicIntegerArray() {
    ...
    // WHEN
    AtomicIntegerArrayAssert result = then(actual);
    // THEN
  ...
  void should_accept_AtomicIntegerFieldUpdater() {
    ...
    // WHEN
    AtomicIntegerFieldUpdaterAssert<UpdaterTarget> result = then(actual);
    // THEN
    result.isNotNull();
  }
  ...
  void should_accept_AtomicLong() {
    ...
    // WHEN
    AtomicLongAssert result = then(actual);
    // THEN
    result.hasValue(0L);
  }
  ...
  void should_accept_AtomicLongArray() {
    ...
    // WHEN
    AtomicLongArrayAssert result = then(actual);
    // THEN
  ...
  void should_accept_AtomicLongFieldUpdater() {
    ...
    // WHEN
    AtomicLongFieldUpdaterAssert<UpdaterTarget> result = then(actual);
    // THEN
    result.isNotNull();
  }
  ...
  void should_accept_AtomicMarkableReference() {
    ...
    // WHEN
    AtomicMarkableReferenceAssert<String> result = then(actual);
    // THEN
  ...
  void should_accept_AtomicReference() {
    ...
    // WHEN
    AtomicReferenceAssert<String> result = then(actual);
    // THEN
  ...
  void should_accept_AtomicReferenceArray() {
    ...
    // WHEN
    AtomicReferenceArrayAssert<String> result = then(actual);
    // THEN
  ...
  void should_accept_AtomicReferenceFieldUpdater() {
    ...
    AtomicReferenceFieldUpdater<UpdaterTarget, String> actual = AtomicReferenceFieldUpdater.newUpdater(UpdaterTarget.class,
                                                                                                       ...
                                                                                                       "stringValue");
    // WHEN
    AtomicReferenceFieldUpdaterAssert<String, UpdaterTarget> result = then(actual);
    // THEN
    result.isNotNull();
  }
  ...
  void should_accept_AtomicStampedReference() {
    ...
    // WHEN
    AtomicStampedReferenceAssert<String> result = then(actual);
    // THEN
    result.hasReference("Yoda");
  }
  ...
  void should_accept_BigDecimal() {
    ...
    // WHEN
    AbstractBigDecimalAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_BigInteger() {
    ...
    // WHEN
    AbstractBigIntegerAssert<?> result = then(actual);
    // THEN
    result.isZero();
  }
  ...
  void should_accept_boolean_2d_array() {
    ...
    // WHEN
    Boolean2DArrayAssert result = then(actual);
    // THEN
  ...
  void should_accept_boolean_array() {
    ...
    // WHEN
    AbstractBooleanArrayAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_byte_2d_array() {
    ...
    byte[][] actual = { { 0, 1 }, { 2, 3 } };
    // WHEN
    Byte2DArrayAssert result = then(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_byte_array() {
    ...
    byte[] actual = { 0, 1 };
    // WHEN
    AbstractByteArrayAssert<?> result = then(actual);
    // THEN
    result.containsExactly(0, 1);
  }
  ...
  void should_accept_char_2d_array() {
    ...
    char[][] actual = { { 'a', 'b' }, { 'c', 'd' } };
    // WHEN
    Char2DArrayAssert result = then(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_char_array() {
    ...
    char[] actual = { 'a', 'b' };
    // WHEN
    AbstractCharArrayAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_CharSequence() {
    ...
    // WHEN
    AbstractCharSequenceAssert<?, ? extends CharSequence> result = then(actual);
    // THEN
  ...
  void should_accept_Class() {
    ...
    // WHEN
    AbstractClassAssert<?> result = then(actual);
    // THEN
    result.isPublic();
  }
  ...
  void should_accept_ClassLoader() {
    ...
    // WHEN
    ObjectAssert<ClassLoader> result = then(actual);
    // THEN
  ...
  void should_accept_Collection() {
    ...
    // WHEN
    AbstractCollectionAssert<?, Collection<? extends String>, String, ObjectAssert<String>> result = then(actual);
    // THEN
  ...
  // // WHEN
  // AbstractComparableAssert<?, UUID> result = then(actual);
  // // THEN
  ...
  void should_accept_CompletableFuture() {
    ...
    // WHEN
    CompletableFutureAssert<String> result = then(actual);
    // THEN
    result.isDone();
  }
  ...
  void should_accept_Date() {
    ...
    // WHEN
    AbstractDateAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_double_2d_array() {
    ...
    // WHEN
    Double2DArrayAssert result = then(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_double_array() {
    ...
    // WHEN
    AbstractDoubleArrayAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_DoublePredicate() {
    ...
    // WHEN
    DoublePredicateAssert result = then(actual);
    // THEN
    result.accepts(1.0);
  }
  ...
  void should_accept_DoubleStream() {
    ...
    // WHEN
    ListAssert<Double> result = then(actual);
    // THEN
    result.contains(1.0);
  }
  ...
  void should_accept_Duration() {
    ...
    // WHEN
    AbstractDurationAssert<?> result = then(actual);
    // THEN
    result.hasHours(10);
  }
  ...
  void should_accept_File() {
    ...
    // WHEN
    AbstractFileAssert<?> result = then(actual);
    // THEN
    result.doesNotExist();
  }
  ...
  void should_accept_float_2d_array() {
    ...
    // WHEN
    Float2DArrayAssert result = then(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_float_array() {
    ...
    // WHEN
    AbstractFloatArrayAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_Future() {
    ...
    // WHEN
    FutureAssert<String> result = then(actual);
    // THEN
    result.isDone();
  }
  ...
  void should_accept_InputStream() {
    ...
    // WHEN
    AbstractInputStreamAssert<?, ? extends InputStream> result = then(actual);
    // THEN
  ...
  void should_accept_Instant() {
    ...
    // WHEN
    AbstractInstantAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_int_2d_array() {
    ...
    int[][] actual = { { 0, 1 }, { 2, 3 } };
    // WHEN
    Int2DArrayAssert result = then(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_int_array() {
    ...
    int[] actual = { 0, 1 };
    // WHEN
    AbstractIntArrayAssert<?> result = then(actual);
    // THEN
    result.containsExactly(0, 1);
  }
  ...
  void should_accept_IntPredicate() {
    ...
    // WHEN
    IntPredicateAssert result = then(actual);
    // THEN
    result.accepts(1);
  }
  ...
  void should_accept_IntStream() {
    ...
    // WHEN
    ListAssert<Integer> result = then(actual);
    // THEN
    result.contains(1);
  }
  ...
  void should_accept_Iterable() {
    ...
    // WHEN
    IterableAssert<String> result = then(actual);
    // THEN
    result.contains("Yoda");
  }
  ...
  void should_accept_Iterator() {
    ...
    // WHEN
    IteratorAssert<String> result = then(actual);
    // THEN
    result.hasNext();
  }
  ...
  void should_accept_List() {
    ...
    // WHEN
    ListAssert<String> result = then(actual);
    // THEN
    result.contains("Yoda");
  }
  ...
  void should_accept_LocalDate() {
    ...
    // WHEN
    AbstractLocalDateAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_LocalDateTime() {
    ...
    // WHEN
    AbstractLocalDateTimeAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_LocalTime() {
    ...
    // WHEN
    AbstractLocalTimeAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_long_2d_array() {
    ...
    // WHEN
    Long2DArrayAssert result = then(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_long_array() {
    ...
    long[] actual = { 0L, 1L };
    // WHEN
    AbstractLongArrayAssert<?> result = then(actual);
    // THEN
    result.containsExactly(0L, 1L);
  }
  ...
  void should_accept_LongAdder() {
    ...
    // WHEN
    LongAdderAssert result = then(actual);
    // THEN
    result.hasValue(0L);
  }
  ...
  void should_accept_LongPredicate() {
    ...
    // WHEN
    LongPredicateAssert result = then(actual);
    // THEN
    result.accepts(1L);
  }
  ...
  void should_accept_LongStream() {
    ...
    // WHEN
    ListAssert<Long> result = then(actual);
    // THEN
    result.contains(1L);
  }
  ...
  void should_accept_Map() {
    ...
    // WHEN
    MapAssert<String, String> result = then(actual);
    // THEN
  ...
  void should_accept_Matcher() {
    ...
    // WHEN
    MatcherAssert result = then(actual);
    // THEN
    result.matches();
  }
  ...
  void should_accept_Object() {
    ...
    // WHEN
    ObjectAssert<Object> result = then(actual);
    // THEN
    result.isNotNull();
  }
  ...
  void should_accept_object_2d_array() {
    ...
    // WHEN
    Object2DArrayAssert<String> result = then(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_object_array() {
    ...
    // WHEN
    ObjectArrayAssert<String> result = then(actual);
    // THEN
  ...
  void should_accept_OffsetDateTime() {
    ...
    // WHEN
    AbstractOffsetDateTimeAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_OffsetTime() {
    ...
    // WHEN
    AbstractOffsetTimeAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_Optional() {
    ...
    // WHEN
    OptionalAssert<String> result = then(actual);
    // THEN
    result.contains("Yoda");
  }
  ...
  void should_accept_OptionalDouble() {
    ...
    // WHEN
    OptionalDoubleAssert result = then(actual);
    // THEN
    result.hasValue(1.0);
  }
  ...
  void should_accept_OptionalInt() {
    ...
    // WHEN
    OptionalIntAssert result = then(actual);
    // THEN
    result.hasValue(1);
  }
  ...
  void should_accept_OptionalLong() {
    ...
    // WHEN
    OptionalLongAssert result = then(actual);
    // THEN
    result.hasValue(1L);
  }
  ...
  void should_accept_Path() {
    ...
    // WHEN
    AbstractPathAssert<?> result = then(actual);
    // THEN
    result.doesNotExist();
  }
  ...
  void should_accept_Period() {
    ...
    // WHEN
    AbstractPeriodAssert<?> result = then(actual);
    // THEN
    result.hasYears(1);
  }
  ...
  void should_accept_Predicate() {
    ...
    // WHEN
    PredicateAssert<String> result = then(actual);
    // THEN
    result.accepts("Yoda");
  }
  ...
  void should_accept_short_2d_array() {
    ...
    // WHEN
    Short2DArrayAssert result = then(actual);
    // THEN
    result.hasDimensions(2, 2);
  }
  ...
  void should_accept_short_array() {
    ...
    // WHEN
    AbstractShortArrayAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_Spliterator() {
    ...
    // WHEN
    SpliteratorAssert<String> result = then(actual);
    // THEN
  ...
  void should_accept_Throwable() {
    ...
    // WHEN
    AbstractThrowableAssert<?, RuntimeException> result = then(actual);
    // THEN
  ...
  void should_accept_URI() {
    ...
    // WHEN
    AbstractUriAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_URL() throws MalformedURLException {
    ...
    // WHEN
    AbstractUrlAssert<?> result = then(actual);
    // THEN
    result.hasHost("localhost");
  }
  ...
  void should_accept_Year() {
    ...
    // WHEN
    AbstractComparableAssert<?, Year> result = then(actual);
    // THEN
  ...
  void should_accept_YearMonth() {
    ...
    // WHEN
    AbstractYearMonthAssert<?> result = then(actual);
    // THEN
  ...
  void should_accept_ZonedDateTime() {
    ...
    // WHEN
    AbstractZonedDateTimeAssert<?> result = then(actual);
    // THEN
  ...
  private static class TestAssert extends AbstractAssert<TestAssert, TestAssertProvider> {
    ...
    TestAssert containsText(String text) {
      then(actual.text).contains(text);
      return this;
    }
