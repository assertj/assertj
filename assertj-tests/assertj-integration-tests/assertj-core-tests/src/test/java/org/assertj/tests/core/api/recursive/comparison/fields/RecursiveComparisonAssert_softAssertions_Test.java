...
class RecursiveComparisonAssert_softAssertions_Test extends WithComparingFieldsIntrospectionStrategyBaseTest {
  ...
  void should_pass_with_soft_assertions() {
    ...
    // WHEN
    softly.assertThat(actual).usingRecursiveComparison(recursiveComparisonConfiguration).isEqualTo(expected);
    // THEN
    softly.assertAll();
  }
  ...
  void should_report_all_errors_with_soft_assertions() {
    ...
    // WHEN
    softly.assertThat(john).usingRecursiveComparison(recursiveComparisonConfiguration).isEqualTo(jack);
    softly.assertThat(jack).usingRecursiveComparison(recursiveComparisonConfiguration).isEqualTo(john);
    // THEN
