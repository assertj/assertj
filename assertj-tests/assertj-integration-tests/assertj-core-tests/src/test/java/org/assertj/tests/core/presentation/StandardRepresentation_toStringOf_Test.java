...
class StandardRepresentation_toStringOf_Test extends AbstractBaseRepresentationTest {
  ...
  void should_return_toString_of_Timestamp_with_millisecond_precision_only() {
    // GIVEN
    Timestamp timestampWithMsOnly = Timestamp.from(Instant.parse("2011-06-18T16:53:17.123Z"));
    // WHEN
    String representation = STANDARD_REPRESENTATION.toStringOf(timestampWithMsOnly);
    // THEN
  ...
  void should_return_toString_of_Timestamp_including_sub_millisecond_nanos() {
    ...
    Timestamp timestampWithNanos = Timestamp.from(Instant.parse("2011-06-18T16:53:17.123456789Z"));
    // WHEN
