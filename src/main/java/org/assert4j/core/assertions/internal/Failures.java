...
import static org.assert4j.core.util.Strings.isNullOrEmpty;

import org.assert4j.core.assertions.core.AssertionInfo;
import org.assert4j.core.assertions.error.AssertionErrorFactory;
import org.assert4j.core.assertions.error.ErrorMessageFactory;
import org.assert4j.core.assertions.error.MessageFormatter;
import org.assert4j.core.assertions.error.ShouldBeEqual;
import org.assert4j.core.util.Throwables;
...
org.junit.ComparisonFailure: expected:<'[Ronaldo]'> but was:<'[Messi]'>
   ...
   * </pre>
   * 
   * Method is public because we need to call it from {@link ShouldBeEqual#newAssertionError(org.assert4j.core.assertions.description.Description)} that is building a junit ComparisonFailure by reflection. 
   *  
