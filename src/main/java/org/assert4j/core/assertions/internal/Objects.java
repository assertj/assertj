...
import static org.assert4j.core.assertions.error.ShouldBeEqual.shouldBeEqual;
import static org.assert4j.core.assertions.error.ShouldBeExactlyInstanceOf.shouldBeExactlyInstance;
import static org.assert4j.core.assertions.error.ShouldBeIn.shouldBeIn;
import static org.assert4j.core.assertions.error.ShouldBeInstance.shouldBeInstance;
import static org.assert4j.core.assertions.error.ShouldBeInstance.shouldBeInstanceButWasNull;
import static org.assert4j.core.assertions.error.ShouldBeInstanceOfAny.shouldBeInstanceOfAny;
import static org.assert4j.core.assertions.error.ShouldBeLenientEqualByAccepting.shouldBeLenientEqualByAccepting;
import static org.assert4j.core.assertions.error.ShouldBeLenientEqualByIgnoring.shouldBeLenientEqualByIgnoring;
import static org.assert4j.core.assertions.error.ShouldBeOfClassIn.shouldBeOfClassIn;
import static org.assert4j.core.assertions.error.ShouldBeSame.shouldBeSame;
import static org.assert4j.core.assertions.error.ShouldHaveSameClass.shouldHaveSameClass;
import static org.assert4j.core.assertions.error.ShouldNotBeEqual.shouldNotBeEqual;
import static org.assert4j.core.assertions.error.ShouldNotBeExactlyInstanceOf.shouldNotBeExactlyInstance;
import static org.assert4j.core.assertions.error.ShouldNotBeIn.shouldNotBeIn;
import static org.assert4j.core.assertions.error.ShouldNotBeInstance.shouldNotBeInstance;
import static org.assert4j.core.assertions.error.ShouldNotBeInstanceOfAny.shouldNotBeInstanceOfAny;
import static org.assert4j.core.assertions.error.ShouldNotBeNull.shouldNotBeNull;
import static org.assert4j.core.assertions.error.ShouldNotBeOfClassIn.shouldNotBeOfClassIn;
import static org.assert4j.core.assertions.error.ShouldNotBeSame.shouldNotBeSame;
import static org.assert4j.core.assertions.error.ShouldNotHaveSameClass.shouldNotHaveSameClass;
import static org.assert4j.core.util.Lists.newArrayList;
import static org.assert4j.core.util.Sets.newLinkedHashSet;
import static org.assert4j.core.util.ToString.toStringOf;
    ...
    for (Field field : getDeclaredFieldsIncludingInherited(actual.getClass())) {
      try {
        if (!ignoredFields.contains(field.getName())) {
          ...
          Object actualFieldValue = propertySupport.propertyValue(fieldName, Object.class, actual);
          Object otherFieldValue = propertySupport.propertyValue(fieldName, Object.class, other);
          if (!org.assert4j.core.util.Objects.areEqual(actualFieldValue, otherFieldValue)) {
