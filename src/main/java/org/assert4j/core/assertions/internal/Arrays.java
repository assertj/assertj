...
import static org.assert4j.core.assertions.error.ConditionAndGroupGenericParameterTypeShouldBeTheSame.shouldBeSameGenericBetweenIterableAndCondition;
import static org.assert4j.core.assertions.error.ElementsShouldBe.elementsShouldBe;
import static org.assert4j.core.assertions.error.ElementsShouldBeAtLeast.elementsShouldBeAtLeast;
import static org.assert4j.core.assertions.error.ElementsShouldBeAtMost.elementsShouldBeAtMost;
import static org.assert4j.core.assertions.error.ElementsShouldBeExactly.elementsShouldBeExactly;
import static org.assert4j.core.assertions.error.ElementsShouldHave.elementsShouldHave;
import static org.assert4j.core.assertions.error.ElementsShouldHaveAtLeast.elementsShouldHaveAtLeast;
import static org.assert4j.core.assertions.error.ElementsShouldHaveAtMost.elementsShouldHaveAtMost;
import static org.assert4j.core.assertions.error.ElementsShouldHaveExactly.elementsShouldHaveExactly;
import static org.assert4j.core.assertions.error.ElementsShouldNotBe.elementsShouldNotBe;
import static org.assert4j.core.assertions.error.ElementsShouldNotBeAtLeast.elementsShouldNotBeAtLeast;
import static org.assert4j.core.assertions.error.ElementsShouldNotBeAtMost.elementsShouldNotBeAtMost;
...
import static org.assert4j.core.assertions.error.ElementsShouldNotHaveAtMost.elementsShouldNotHaveAtMost;
import static org.assert4j.core.assertions.error.ElementsShouldNotHaveExactly.elementsShouldNotHaveExactly;
import static org.assert4j.core.assertions.error.ShouldBeEmpty.shouldBeEmpty;
import static org.assert4j.core.assertions.error.ShouldBeNullOrEmpty.shouldBeNullOrEmpty;
import static org.assert4j.core.assertions.error.ShouldBeSorted.*;
import static org.assert4j.core.assertions.error.ShouldContain.shouldContain;
import static org.assert4j.core.assertions.error.ShouldContainAtIndex.shouldContainAtIndex;
import static org.assert4j.core.assertions.error.ShouldContainNull.shouldContainNull;
import static org.assert4j.core.assertions.error.ShouldContainOnly.shouldContainOnly;
import static org.assert4j.core.assertions.error.ShouldContainSequence.shouldContainSequence;
import static org.assert4j.core.assertions.error.ShouldEndWith.shouldEndWith;
...
import static org.assert4j.core.assertions.error.ShouldNotBeEmpty.shouldNotBeEmpty;
import static org.assert4j.core.assertions.error.ShouldNotContain.shouldNotContain;
import static org.assert4j.core.assertions.error.ShouldNotContainAtIndex.shouldNotContainAtIndex;
import static org.assert4j.core.assertions.error.ShouldNotContainNull.shouldNotContainNull;
...
import static org.assert4j.core.assertions.internal.CommonErrors.*;
import static org.assert4j.core.assertions.internal.CommonValidations.checkIndexValueIsValid;
import static org.assert4j.core.util.ArrayWrapperList.wrap;
import static org.assert4j.core.util.Arrays.isArray;
import static org.assert4j.core.util.Iterables.isNullOrEmpty;
...
import org.assert4j.core.assertions.error.ElementsShouldNotBeExactly;
import org.assert4j.core.util.*;
...
class Arrays {
  ...
  void assertHasSameSizeAs(AssertionInfo info, Failures failures, Object array, Iterable<?> other) {
    ...
    int sizeOfActual = sizeOf(array);
    int sizeOfOther = org.assert4j.core.util.Iterables.sizeOf(other);
