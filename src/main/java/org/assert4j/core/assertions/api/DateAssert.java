...
import static org.assert4j.core.util.Dates.ISO_DATE_FORMAT;
...
import org.assert4j.core.assertions.core.Assert;
import org.assert4j.core.assertions.internal.*;
...
public class DateAssert extends AbstractAssert<DateAssert, Date> {
   ...
   * See {@link org.assert4j.core.util.Dates#monthOf(Date)} to get the month of a given Date.
   * <p>
   * Note that using a custom comparator has no effect on this assertion (see {@link #usingComparator(Comparator)}.
   * 
   * @param other the given {@code Date} to compare actual {@code Date} to.
   ...
   * see {@link org.assert4j.core.util.Dates#dayOfMonthOf(Date)} to get the day of month of a given Date.
   * <p>
   * Note that using a custom comparator has no effect on this assertion (see {@link #usingComparator(Comparator)}.
   * 
   * @param other the given {@code Date} to compare actual {@code Date} to.
   ...
   * see {@link org.assert4j.core.util.Dates#hourOfDay(Date)} to get the hour of a given Date.
   * <p>
   * Note that using a custom comparator has no effect on this assertion (see {@link #usingComparator(Comparator)}.
   * 
   * @param other the given {@code Date} to compare actual {@code Date} to.
   ...
   * see {@link org.assert4j.core.util.Dates#minuteOf(Date)} to get the minute of a given Date.
   * <p>
   * Note that using a custom comparator has no effect on this assertion (see {@link #usingComparator(Comparator)}.
   * 
   * @param other the given {@code Date} to compare actual {@code Date} to.
   ...
   * see {@link org.assert4j.core.util.Dates#secondOf(Date)} to get the second of a given Date.
   * <p>
   * Note that using a custom comparator has no effect on this assertion (see {@link #usingComparator(Comparator)}.
   * 
   * @param other the given {@code Date} to compare actual {@code Date} to.
