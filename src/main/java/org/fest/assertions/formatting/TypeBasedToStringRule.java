...
/**
 * A <code>{@link ToStringRule}</code> that determines whether it can handle a give {@code Object}
 * based on the type of such {@code Object}.
 *
 * @author Alex Ruiz
 */
abstract class TypeBasedToStringRule<T> implements ToStringRule {
