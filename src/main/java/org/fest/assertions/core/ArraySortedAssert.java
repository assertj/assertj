...
public interface ArraySortedAssert<S, E> {
  ...
  /**
   * Verifies that the actual array is sorted according to the given comparator.</br> Empty arrays are considered sorted
   * whatever the comparator is.</br> One element arrays are considered sorted if element is compatible with comparator,
