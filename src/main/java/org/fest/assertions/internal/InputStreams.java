...
public class InputStreams {
  ...
  @VisibleForTesting InputStreams() {}
  ...
  public void assertEqualContent(AssertionInfo info, InputStream actual, InputStream expected) {
    ...
    try {
      ...
      String msg = String.format("Unable to compare contents of InputStreams :<%s> and:<%s>", actual, expected);
      throw new InputStreamsException(msg, e);
    }
  }
  
  private void verifyExpected(InputStream expected) {
