...
public class Lists {
  ...
  /**
   * Verifies that given {@code List} contains the given object at the given index.
  ...
  public void assertContains(AssertionInfo info, List<?> actual, Object value, Index index) {
    assertNotNullAndNotEmpty(info, actual);
  ...
  private static void assertNotNullAndNotEmpty(AssertionInfo info, List<?> actual) {
