...
/**
 * Creates an error message indicating that an assertion that verifies that an object has same class as another instance
 * failed.
 * 
...
public class ShouldNotHaveSameClass extends BasicErrorMessageFactory {
  ...
  private ShouldNotHaveSameClass(Object actual, Object other) {
    super("expected <%s> not to have not the same class as:<%s> (%s)", actual, other, actual.getClass());
  }
}
