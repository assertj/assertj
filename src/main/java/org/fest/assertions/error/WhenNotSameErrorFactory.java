 ...
 * @author Alex Ruiz
 */
public class WhenNotSameErrorFactory implements AssertionErrorFactory {

  @VisibleForTesting final Object actual;
  @VisibleForTesting final Object expected;

  /**
   * Creates instances of <code>{@link WhenNotSameErrorFactory}</code>.
   * @param actual the actual value in the failed assertion.
   * @param expected the expected value in the failed assertion.
   * @return an instance of {@code ErrorWhenNotSameFactory}.
   */
  public static AssertionErrorFactory errorWhenNotSame(Object actual, Object expected) {
    return new WhenNotSameErrorFactory(actual, expected);
  }

  @VisibleForTesting WhenNotSameErrorFactory(Object actual, Object expected) {
    this.actual = actual;
  ...
  @Override public boolean equals(Object obj) {
    ...
    WhenNotSameErrorFactory other = (WhenNotSameErrorFactory) obj;
