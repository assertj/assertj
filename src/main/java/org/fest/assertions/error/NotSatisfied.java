...
public class NotSatisfied extends BasicErrorMessage {
   ...
   */
  public static <T> NotSatisfied notSatisfied(T actual, Condition<T> condition) {
    return new NotSatisfied(actual, condition);
  }

  private NotSatisfied(Object actual, Condition<?> condition) {
