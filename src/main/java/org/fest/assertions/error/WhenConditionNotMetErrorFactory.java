...
/**
 * Creates an <code>{@link AssertionError}</code> when an assertion that verifies that a value satisfies a
 * <code>{@link Condition}</code> fails.
 *
 * @author Alex Ruiz
 */
public class WhenConditionNotMetErrorFactory implements AssertionErrorFactory {

  @VisibleForTesting final Object actual;
  @VisibleForTesting final Condition<?> condition;

  /**
   * Creates instances of <code>{@link WhenConditionNotMetErrorFactory}</code>.
   * @param actual the actual value in the failed assertion.
   * @param condition the {@code Condition}.
   * @return an instance of {@code WhenConditionNotMetErrorFactory}.
   */
  public static AssertionErrorFactory errorWhenConditionNotMet(Object actual, Condition<?> condition) {
    return new WhenConditionNotMetErrorFactory(actual, condition);
  }

  @VisibleForTesting WhenConditionNotMetErrorFactory(Object actual, Condition<?> condition) {
    this.actual = actual;
  ...
  @Override public boolean equals(Object obj) {
    ...
    WhenConditionNotMetErrorFactory other = (WhenConditionNotMetErrorFactory) obj;
