 ...
 * @author Alex Ruiz
 */
public class WhenConditionMetErrorFactory implements AssertionErrorFactory {

  @VisibleForTesting final Object actual;
  @VisibleForTesting final Condition<?> condition;

  /**
   * Creates instances of <code>{@link WhenConditionMetErrorFactory}</code>.
  ...
  public static AssertionErrorFactory errorWhenConditionMet(Object actual, Condition<?> condition) {
    return new WhenConditionMetErrorFactory(actual, condition);
  }

  @VisibleForTesting WhenConditionMetErrorFactory(Object actual, Condition<?> condition) {
    this.actual = actual;
  ...
  @Override public boolean equals(Object obj) {
    ...
    WhenConditionMetErrorFactory other = (WhenConditionMetErrorFactory) obj;
