...
public class NotLessThan extends ErrorMessage {
   ...
   */
  public static <T extends Comparable<T>> NotLessThan notLessThan(T actual, T other) {
    return new NotLessThan(actual, other);
  }

  private NotLessThan(Comparable<?> actual, Comparable<?> other) {
