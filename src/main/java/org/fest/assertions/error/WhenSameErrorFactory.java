 ...
 * @author Alex Ruiz
 */
public class WhenSameErrorFactory implements AssertionErrorFactory {

  @VisibleForTesting final Object actual;

  /**
   * Creates instances of <code>{@link WhenSameErrorFactory}</code>.
   * @param actual the actual value in the failed assertion.
   * @return an instance of {@code WhenSameErrorFactory}.
   */
  public static AssertionErrorFactory errorWhenSame(Object actual) {
    return new WhenSameErrorFactory(actual);
  }

  @VisibleForTesting WhenSameErrorFactory(Object actual) {
    this.actual = actual;
  }
  ...
  @Override public boolean equals(Object obj) {
    ...
    WhenSameErrorFactory o = (WhenSameErrorFactory) obj;
