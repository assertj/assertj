 ...
 * @author Yvonne Wang
 */
public class WhenSizeNotEqualErrorFactory implements AssertionErrorFactory {
  ...
  /**
   * Creates instances of <code>{@link WhenSizeNotEqualErrorFactory}</code>.
  ...
  public static AssertionErrorFactory errorWhenSizeNotEqual(Object actual, int actualSize, int expectedSize) {
    return new WhenSizeNotEqualErrorFactory(actual, actualSize, expectedSize);
  }

  @VisibleForTesting WhenSizeNotEqualErrorFactory(Object actual, int actualSize, int expectedSize) {
    this.actual = actual;
  ...
  @Override public boolean equals(Object obj) {
    ...
    WhenSizeNotEqualErrorFactory other = (WhenSizeNotEqualErrorFactory) obj;
