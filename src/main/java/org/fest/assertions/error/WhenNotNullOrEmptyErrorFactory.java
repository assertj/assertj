...
/**
 * Creates an <code>{@link AssertionError}</code> when an assertion that verifies a group of elements (e.g. a
 * collection, an array or a {@code String} is {@code null} or empty fails.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
