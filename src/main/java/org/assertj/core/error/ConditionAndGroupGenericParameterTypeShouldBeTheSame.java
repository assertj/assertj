...
/**
 * Creates an error message indicating that an assertion that verifies type of elements of group and {@code Condition} A
 * group of elements can be a collection, an array.<br>
 * 
