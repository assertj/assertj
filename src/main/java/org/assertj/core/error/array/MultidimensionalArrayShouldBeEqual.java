...
public class MultidimensionalArrayShouldBeEqual extends org.assertj.core.error.ShouldBeEqual {
  ...
  private static final String EXPECTED_BUT_WAS_MESSAGE = "%nExpecting %s value to be equal to:%n <%s>%nbut " +
                                                         "was%n <%s>%n.";
  private static final String EXPECTED_BUT_WAS_MESSAGE_USING_COMPARATOR = "%nExpecting %s value to be equal " +
                                                                          "to:%n <%s>%n%s%nbut was%n <%s>%n.";
  @VisibleForTesting
  ...
  public int hashCode() {
    ...
    result = HASH_CODE_PRIME * result + hashCodeFor(index);
    return result;
  }
