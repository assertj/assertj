...
/**
 * Creates an error message indicating that an assertion that verifies that an object is not of type in group of types
 * failed.
 * 
...
public class ShouldNotBeOfClassIn extends BasicErrorMessageFactory {
  ...
  private ShouldNotBeOfClassIn(Object actual, Object types) {
    super("\nExpecting:\n <%s>\nnot to be of any type in:\n <%s>\nbut was of type:<%s>", actual, types, actual
        .getClass());
  }
}
