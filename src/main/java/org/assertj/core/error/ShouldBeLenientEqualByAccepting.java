...
public class ShouldBeLenientEqualByAccepting extends BasicErrorMessageFactory {
  ...
  private ShouldBeLenientEqualByAccepting(Object actual, List<String> rejectedFields, List<Object> expectedValue,
    ...
    super("expected values:\n<%s>\n in fields:\n<%s>\n of <%s>.\nComparison was performed on fields <%s>",
        expectedValue, rejectedFields, actual, acceptedFields);
  }

  private ShouldBeLenientEqualByAccepting(Object actual, String rejectedField, Object rejectedValue,
      List<String> acceptedFields) {
    super("expected value <%s> in field <%s> of <%s>.\nComparison was performed on fields <%s>", rejectedValue,
        rejectedField, actual, acceptedFields);
  }
