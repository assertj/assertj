...
/**
 * Creates an error message indicating that an assertion that verifies that an object have same class as another
 * instance failed.
 * 
...
public class ShouldHaveSameClass extends BasicErrorMessageFactory {
  ...
  private ShouldHaveSameClass(Object actual, Object other) {
    super("\nExpecting\n <%s>\nto have the same class as:\n <%s>(<%s>) \nbut its class was:<%s>", actual, other, other
        .getClass(), actual.getClass());
  }
}
