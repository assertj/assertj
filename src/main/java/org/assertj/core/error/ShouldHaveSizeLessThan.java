 ...
 * less than a certain size - failed.
 *
...
public class ShouldHaveSizeLessThan extends BasicErrorMessageFactory {
   ...
   */
  public static ErrorMessageFactory shouldHaveSizeLessThan(Object actual, int actualSize, int expectedSize) {
    return new ShouldHaveSizeLessThan(actual, actualSize, expectedSize);
  }
