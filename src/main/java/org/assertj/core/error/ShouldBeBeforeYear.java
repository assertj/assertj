...
/**
 * Creates an error message indicating that an assertion that verifies that a {@link Date} is before given year failed.
 * 
...
public class ShouldBeBeforeYear extends BasicErrorMessageFactory {
  ...
  public static ErrorMessageFactory shouldBeBeforeYear(Date actual, int year, ComparisonStrategy comparisonStrategy) {
    return new ShouldBeBeforeYear(actual, year, comparisonStrategy);
  }
  ...
  public static ErrorMessageFactory shouldBeBeforeYear(Date actual, int year) {
    return new ShouldBeBeforeYear(actual, year, StandardComparisonStrategy.instance());
  }

  private ShouldBeBeforeYear(Date actual, int year, ComparisonStrategy comparisonStrategy) {
    super("%nExpecting year of:%n  %s%nto be strictly before year:%n  %s%n%s", actual, year, comparisonStrategy);
  }
}
