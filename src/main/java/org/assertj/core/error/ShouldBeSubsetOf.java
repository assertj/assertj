...
/**
 * Creates an error message indicating that an assertion that verifies that an <code>Iterable</code> is a subset of an
 * other set <code>Iterable</code> failed.
 * 
