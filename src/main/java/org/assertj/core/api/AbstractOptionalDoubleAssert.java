...
public abstract class AbstractOptionalDoubleAssert<S extends AbstractOptionalDoubleAssert<S>> extends
     ...
     * assertThat((OptionalDouble)null).hasValue(8.0);
     ...
     * assertThat((OptionalDouble)null).hasValueCloseTo(8.0, within(1d));
    ...
    public S hasValueCloseTo(Double expectedValue, Offset<Double> offset) {
        ...
        try {
            ...
            throw Failures.instance().failure(info, shouldHaveValueCloseTo(actual, expectedValue, offset,
