 ...
 * {@link StrictAssertions#assertThat(Iterable) assertThat}(newEmployees).{@link IterableAssert#hasSize(int) hasSize}(6);
 * </code></pre>
 * <p/>
 * </p>
 *
...
public class StrictAssertions {
   ...
   *
   * {@link StrictAssertions#shouldHaveThrown(Class)} can be used as a replacement.
   */
   ...
   * <ul>
   * <li>
   * <code><code>{@link AbstractIterableAssert#usingElementComparatorOnFields(String...)}</code>
   * </li>
   * <li><code>{@link AbstractObjectAssert#isEqualToComparingFieldByField(A)}</code></li>
   * </ul>
   *
