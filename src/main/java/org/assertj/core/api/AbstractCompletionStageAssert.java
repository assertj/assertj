...
import org.assertj.core.internal.CompletionStages;
 ...
 */
public abstract class AbstractCompletionStageAssert<SELF extends AbstractCompletionStageAssert<SELF, RESULT>, RESULT> extends
    AbstractAssert<SELF, CompletionStage<RESULT>> {

  protected AbstractCompletionStageAssert(CompletionStage<RESULT> actual, Class<?> selfType) {
  ...
  public SELF isDone() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (!actualFuture.isDone()) throwAssertionError(shouldBeDone(actualFuture));
    return myself;
  }
  ...
  public SELF isNotDone() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (actualFuture.isDone()) throwAssertionError(shouldNotBeDone(actualFuture));
    return myself;
  }
  ...
  public SELF isCompletedExceptionally() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (!actualFuture.isCompletedExceptionally()) throwAssertionError(shouldHaveCompletedExceptionally(actualFuture));
    return myself;
  }
  ...
  public SELF isNotCompletedExceptionally() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (actualFuture.isCompletedExceptionally()) throwAssertionError(shouldNotHaveCompletedExceptionally(actualFuture));
    return myself;
  }
  ...
  public SELF isCancelled() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (!actualFuture.isCancelled()) throwAssertionError(shouldBeCancelled(actualFuture));
    return myself;
  }
  ...
  public SELF isNotCancelled() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (actualFuture.isCancelled()) throwAssertionError(shouldNotBeCancelled(actualFuture));
    return myself;
  }
  ...
  public SELF isCompleted() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (!actualFuture.isDone() || actualFuture.isCompletedExceptionally()) throwAssertionError(shouldBeCompleted(actualFuture));
    return myself;
  }
  ...
  public SELF isNotCompleted() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (actualFuture.isDone() && !actualFuture.isCompletedExceptionally()) throwAssertionError(shouldNotBeCompleted(actualFuture));
    return myself;
  }
  ...
  public SELF isCompletedWithValue(RESULT expected) {
    isCompleted();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    RESULT actualResult = actualFuture.join();
  ...
  public SELF hasFailed() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (!actualFuture.isCompletedExceptionally() || actualFuture.isCancelled()) throwAssertionError(shouldHaveFailed(actualFuture));
    return myself;
  }
  ...
  public SELF hasNotFailed() {
    isNotNull();
    CompletableFuture<RESULT> actualFuture = actual.toCompletableFuture();
    if (actualFuture.isCompletedExceptionally() && !actualFuture.isCancelled()) throwAssertionError(shouldNotHaveFailed(actualFuture));
    return myself;
  }
