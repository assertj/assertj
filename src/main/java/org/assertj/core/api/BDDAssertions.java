 ...
 * for the type-specific assertion objects. The purpose of this class is to make test code more readable. <p> For
 * example: <p/>
 * <pre>
 * int removed = employees.removeFired();
 * {@link org.assertj.core.api.BDDAssertions#then(int) then}(removed).{@link org.assertj.core.api.IntegerAssert#isZero isZero}();
 *
 * List&lt;Employee&gt; newEmployees = employees.hired(TODAY);
 * {@link org.assertj.core.api.BDDAssertions#then(Iterable) then}(newEmployees).{@link org.assertj.core.api.IterableAssert#hasSize(int) hasSize}(6);
 * </pre>
 * <p/> </p>
 *
 * @author Alex Ruiz
