...
public abstract class AbstractDateAssert<SELF extends AbstractDateAssert<SELF>> extends AbstractAssert<SELF, Date> {
  ...
  /**
   * Same assertion as {@link #isBetween(Date, Date)} but given period is represented as {@link java.time.Instant}.
   * <p>
   * Example:
  ...
  /**
   * Same assertion as {@link #isBetween(Date, Date, boolean, boolean)} but given period is represented as {@link java.time.Instant}.
   * <p>
   * Example:
