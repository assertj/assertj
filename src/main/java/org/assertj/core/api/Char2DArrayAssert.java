...
public class Char2DArrayAssert extends Abstract2DArrayAssert<Char2DArrayAssert, char[][], Character> {
  ...
  /**
   * Verifies that the actual array contains the given char[] at the given index.
   * <p>
   * Example:
  ...
  /**
   * Verifies that the actual array does not contain the given char[] at the given index.
   * <p>
   * Example:
   * <pre><code class='java'> // assertion will pass
