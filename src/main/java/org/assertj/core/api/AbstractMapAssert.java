...
public abstract class AbstractMapAssert<SELF extends AbstractMapAssert<SELF, ACTUAL, K, V>, ACTUAL extends Map<K, V>, K, V>
   ...
   */
  @SafeVarargs
  public final SELF contains(@SuppressWarnings("unchecked") Map.Entry<? extends K, ? extends V>... entries) {
   ...
   */
  @SafeVarargs
  public final SELF containsAnyOf(@SuppressWarnings("unchecked") Map.Entry<? extends K, ? extends V>... entries) {
   ...
   */
  @SafeVarargs
  public final SELF doesNotContain(@SuppressWarnings("unchecked") Map.Entry<? extends K, ? extends V>... entries) {
   ...
   */
  @SafeVarargs
  public final SELF containsKeys(@SuppressWarnings("unchecked") K... keys) {
   ...
   */
  @SafeVarargs
  public final SELF doesNotContainKeys(@SuppressWarnings("unchecked") K... keys) {
   ...
   */
  @SafeVarargs
  public final SELF containsOnlyKeys(@SuppressWarnings("unchecked") K... keys) {
   ...
   */
  @SafeVarargs
  public final SELF containsValues(@SuppressWarnings("unchecked") V... values) {
   ...
   */
  @SafeVarargs
  public final SELF containsOnly(@SuppressWarnings("unchecked") Map.Entry<? extends K, ? extends V>... entries) {
   ...
   */
  @SafeVarargs
  public final SELF containsExactly(@SuppressWarnings("unchecked") Map.Entry<? extends K, ? extends V>... entries) {
  ...
  @CheckReturnValue
  @SafeVarargs
  public final AbstractListAssert<?, List<? extends V>, V, ObjectAssert<V>> extractingByKeys(@SuppressWarnings("unchecked") K... keys) {
  ...
  @CheckReturnValue
  @SafeVarargs
  public final AbstractListAssert<?, List<? extends Tuple>, Tuple, ObjectAssert<Tuple>> extractingFromEntries(@SuppressWarnings("unchecked") Function<? super Map.Entry<K, V>, Object>... extractors) {
