...
public abstract class AbstractMapAssert<SELF extends AbstractMapAssert<SELF, ACTUAL, K, V>, ACTUAL extends Map<K, V>, K, V>
   ...
   *
   * // assertion will pass
   * List&lt;Ring&gt; keysToCheck = Arrays.asList(oneRing, nenya, narya, vilya);
   * assertThat(ringBearers).containsOnlyKeys(keysToCheck);
   *
   * // assertion will fail
   * keysToCheck = Arrays.asList(oneRing, nenya);
   * assertThat(ringBearers).containsOnlyKeys(keysToCheck);
   *
   * List&lt;Ring&gt; keysToCheck = Arrays.asList(oneRing, nenya, narya, vilya, unknownRing);
   * assertThat(ringBearers).containsOnlyKeys(keysToCheck);
   *
   * </code></pre>
   *
