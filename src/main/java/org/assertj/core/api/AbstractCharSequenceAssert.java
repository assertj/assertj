...
public abstract class AbstractCharSequenceAssert<S extends AbstractCharSequenceAssert<S, A>, A extends CharSequence>
   ...
   *
   * <pre><code class='java'>
   * assertThat(&quot;Gandalf the grey&quot;).contains(Arrays.&lt;CharSequence&gt;asList(&quot;alf&quot;));
   * assertThat(&quot;Gandalf the grey&quot;).contains(Arrays.&lt;CharSequence&gt;asList(&quot;alf&quot;, &quot;grey&quot;));
   * </code></pre>
   *
   * @param values the Strings to look for.
   * @return {@code this} assertion object.
   ...
   *
   * // this assertion succeeds ...
   * assertThat(book).containsSequence(Arrays.&lt;CharSequence&gt;asList(&quot;{&quot;, &quot;title&quot;, &quot;A Game of Thrones&quot;, &quot;}&quot;));
   *
   * // ... but this one fails as &quot;author&quot; must come after &quot;A Game of Thrones&quot;
   * assertThat(book).containsSequence(Arrays.&lt;CharSequence&gt;asList(&quot;{&quot;, &quot;author&quot;, &quot;A Game of Thrones&quot;, &quot;}&quot;));
   * </code></pre>
   *
   * @param values the Strings to look for, in order.
   * @return {@code this} assertion object.
