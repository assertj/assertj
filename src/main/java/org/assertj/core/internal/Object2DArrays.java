...
public class Object2DArrays<ELEMENT> {
   ...
   */
  public void assertHasSize(AssertionInfo info, ELEMENT[][] actual, int expectedFirstDimensionSize,
   ...
   */
  public void assertHasSameSizeAs(AssertionInfo info, ELEMENT[][] actual, Object other) {
