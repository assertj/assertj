...
class ElementsSatisfyingConsumer <E> {
  ...
  ElementsSatisfyingConsumer(Iterable<? extends E> actual, Consumer<? super E> consumer) {
    this(filterByPassingAssertions(actual, consumer));
  }
  ...
  private static <E> List<E> filterByPassingAssertions(Iterable<? extends E> actual, Consumer<? super E> consumer) {
    return stream(actual)
                         .filter(byPassingAssertions(consumer))
                         .collect(toList());
  }
}
