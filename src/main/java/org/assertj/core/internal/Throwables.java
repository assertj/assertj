...
public class Throwables {
  ...
  private static void doCommonCheckForMessages(AssertionInfo info, Throwable actual,
    CharSequence[] values) {
  ...
  private static void checkCharSequenceArrayDoesNotHaveNullElements(CharSequence[] values) {
    if (values.length == 1) {
      ...
      for (int i = 0; i < values.length; i++) {
        requireNonNull(values[i],
          "Expecting CharSequence elements not to be null but found one at index " + i);
      }
    }
  }
   ...
   * @throws AssertionError if the message of the actual {@code Throwable} is not equal to the given
   *                        one.
   */
  public void assertHasMessage(AssertionInfo info, Throwable actual, String expectedMessage) {
    ...
    throw failures.failure(info, shouldHaveMessage(actual, expectedMessage), actual.getMessage(),
      expectedMessage);
  }
   ...
   */
  public void assertHasCauseReference(AssertionInfo info, Throwable actual,
  ...
  /**
   * Asserts that the message of the root cause of the actual {@code Throwable} is equal to the
   * given one.
   *
   * @param info            contains information about the assertion.
   * @param actual          the given {@code Throwable}.
   ...
   */
  public void assertHasRootCauseMessage(AssertionInfo info, Throwable actual,
    String expectedMessage) {
    assertNotNull(info, actual);
    Throwable rootCause = getRootCause(actual);
    if (null == rootCause) {
      throw failures
        .failure(info, shouldHaveRootCauseWithMessage(actual, rootCause, expectedMessage));
    }
   ...
   * @throws AssertionError if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError if the message of the actual {@code Throwable} does not start with the
   *                        given description.
   */
  public void assertHasMessageStartingWith(AssertionInfo info, Throwable actual,
    String description) {
    assertNotNull(info, actual);
   ...
   * @param info        contains information about the assertion.
   * @param actual      the given {@code Throwable}.
   * @param description the description expected to be contained in the actual {@code Throwable}'s
   *                    message.
   * @throws AssertionError if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError if the message of the actual {@code Throwable} does not contain the
   *                        given description.
   */
   ...
   *                        given description.
   */
  public void assertHasMessageContainingAll(AssertionInfo info, Throwable actual,
    CharSequence... values) {
  ...
  /**
   * Asserts that the message of the actual {@code Throwable} does not contain the given content or
   * is {@code null}.
   *
   * @param info    contains information about the assertion.
   * @param actual  the given {@code Throwable}.
   * @param content the content expected not to be contained in the actual {@code Throwable}'s
   *                message.
   * @throws AssertionError if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError if the message of the actual {@code Throwable} contains the given
   *                        content.
   * @since 3.12.0
   */
  public void assertHasMessageNotContaining(AssertionInfo info, Throwable actual, String content) {
    ...
    throw failures
      .failure(info, shouldNotContain(actual.getMessage(), content), actual.getMessage(), content);
  }

  /**
   * Asserts that the message of the actual {@code Throwable} does not contain any of the given
   * values or is {@code null}.
   *
   * @param info   contains information about the assertion.
   * @param actual the given {@code Throwable}.
   * @param values the contents expected to not be contained in the actual {@code Throwable}'s
   *               message.
   * @throws AssertionError if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError if the message of the actual {@code Throwable} does not contain the
   *                        given description.
   */
  public void assertHasMessageNotContainingAny(AssertionInfo info, Throwable actual,
    CharSequence... values) {
    doCommonCheckForMessages(info, actual, values);
    String actualMessage = actual.getMessage();
    ...
    if (found.size() == 1 && values.length == 1) {
      throw failures
        .failure(info, shouldNotContain(actualMessage, values[0]), actualMessage, values[0]);
    }
    throw failures.failure(info,
      shouldNotContain(actualMessage, values, found, StandardComparisonStrategy.instance()),
      actualMessage, values);
  }

  /**
   * Asserts that the stack trace of the actual {@code Throwable} contains with the given
   * description.
   *
   * @param info        contains information about the assertion.
   * @param actual      the given {@code Throwable}.
   ...
   *                    stack trace.
   * @throws AssertionError if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError if the stack trace of the actual {@code Throwable} does not contain the
   *                        given description.
   */
  public void assertHasStackTraceContaining(AssertionInfo info, Throwable actual,
    String description) {
    assertNotNull(info, actual);
  ...
  /**
   * Asserts that the message of the actual {@code Throwable} matches with the given regular
   * expression.
   *
   * @param info   contains information about the assertion.
   * @param actual the given {@code Throwable}.
   * @param regex  the regular expression of value expected to be matched the actual {@code
   *               Throwable}'s message.
   * @throws AssertionError       if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError       if the message of the actual {@code Throwable} does not match the
  ...
  /**
   * Asserts that a sequence of the message of the actual {@code Throwable} matches with the given
   * regular expression (see {@link java.util.regex.Matcher#find()}). The Pattern used under the
   * hood enables the {@link Pattern#DOTALL} mode.
   *
   * @param info   contains information about the assertion.
   * @param actual the given {@code Throwable}.
   * @param regex  the regular expression expected to be found in the actual {@code Throwable}'s
   *               message.
   * @throws AssertionError       if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError       if the message of the actual {@code Throwable} doesn't contain any
   *                              sequence matching with the given regular expression
   * @throws NullPointerException if the regex is null
   */
   ...
   * @throws AssertionError if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError if the message of the actual {@code Throwable} does not end with the
   *                        given description.
   */
   ...
   * @throws AssertionError       if the cause of the actual {@code Throwable} is not an instance of
   *                              the given type.
   */
  public void assertHasCauseInstanceOf(AssertionInfo info, Throwable actual,
  ...
  /**
   * Assert that the cause of actual {@code Throwable} is <b>exactly</b> an instance of the given
   * type.
   *
   * @param info   contains information about the assertion.
   * @param actual the given {@code Throwable}.
   ...
   * @throws AssertionError       if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError       if the actual {@code Throwable} has no cause.
   * @throws AssertionError       if the cause of the actual {@code Throwable} is not <b>exactly</b>
   *                              an instance of the given type.
   */
  public void assertHasCauseExactlyInstanceOf(AssertionInfo info, Throwable actual,
    Class<? extends Throwable> type) {
    assertNotNull(info, actual);
    checkTypeIsNotNull(type);
   ...
   *                              the given type.
   */
  public void assertHasRootCauseInstanceOf(AssertionInfo info, Throwable actual,
    Class<? extends Throwable> type) {
    assertNotNull(info, actual);
    checkTypeIsNotNull(type);
  ...
  /**
   * Assert that the root cause of actual {@code Throwable} is <b>exactly</b> an instance of the
   * given type.
   *
   * @param info   contains information about the assertion.
   * @param actual the given {@code Throwable}.
   ...
   * @throws AssertionError       if the actual {@code Throwable} is {@code null}.
   * @throws AssertionError       if the actual {@code Throwable} has no cause.
   * @throws AssertionError       if the root cause of the actual {@code Throwable} is not
   *                              <b>exactly</b> an instance of the given type.
   */
  ...
  public void assertHasSuppressedException(AssertionInfo info, Throwable actual,
    ...
    assertNotNull(info, actual);
    requireNonNull(expectedSuppressedException,
      "The expected suppressed exception should not be null");
    Throwable[] suppressed = actual.getSuppressed();
    ...
    throw failures
      .failure(info, shouldHaveSuppressedException(actual, expectedSuppressedException));
  }
}
