...
import static org.assertj.core.error.ShouldHaveMessageMatchingRegex.shouldMatchingRegex;
...
public class Throwables {
  ...
  public void assertHasMessageMatching(AssertionInfo info, Throwable actual, String regex) {
    ...
    throw failures.failure(info, shouldMatchingRegex(actual.getMessage(), regex));
  }
