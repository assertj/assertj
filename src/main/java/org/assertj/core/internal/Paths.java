...
public class Paths {
  ...
  public void assertHasFileSystem(AssertionInfo info, Path actualPath, FileSystem expected) {
    ...
    if (!expected.equals(actual)) {
      throw failures.failure(info, shouldHaveFileSystem(actualPath, expected), actual, expected);
    }
  }
