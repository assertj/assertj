...
import org.assertj.core.assertions.error.AssertionErrorFactory;
import org.assertj.core.assertions.error.ErrorMessageFactory;
import org.assertj.core.assertions.error.MessageFormatter;
import org.assertj.core.assertions.error.ShouldBeEqual;
...
org.junit.ComparisonFailure: expected:<'[Ronaldo]'> but was:<'[Messi]'>
   ...
   * </pre>
   * 
   * Method is public because we need to call it from {@link ShouldBeEqual#newAssertionError(org.assertj.core.assertions.description.Description)} that is building a junit ComparisonFailure by reflection. 
   *  
