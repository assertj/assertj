...
final class BinaryToString {
  ...
  public static String toStringOf(Representation representation, Object object) {
    ...
    if (object instanceof String) {
      return toStringOf(representation, (String) object);
    }
    if (object instanceof Date || object instanceof Calendar) {
      return objectToString(representation, object);
    }
  ...
  private static String toStringOf(Representation representation, String s) {
    return concat("\"", toStringOf(representation, s.toCharArray()), "\"");
  }
