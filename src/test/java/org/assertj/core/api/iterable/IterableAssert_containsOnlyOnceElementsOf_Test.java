...
/**
 * Tests for <code>{@link org.assertj.core.api.AbstractIterableAssert#containsOnlyOnceElementsOf(Iterable)} </code>.
 *
 * @author CAL027
 */
public class IterableAssert_containsOnlyOnceElementsOf_Test extends IterableAssertBaseTest {
