...
public class IterableAssert_usingAdvancedRecursiveFieldByFieldElementComparator_Test extends IterableAssertBaseTest {
  ...
  protected ConcreteIterableAssert<Object> invoke_api_method() {
    return assertions.usingConfigurableRecursiveFieldByFieldElementComparator(recursiveComparisonConfiguration);
  }
  ...
  public void should_be_able_to_use_specific_RecursiveComparisonConfiguration_when_using_recursive_field_by_field_element_comparator() {
    ...
    // WHEN/THEN
    then(singletonList(actual)).usingConfigurableRecursiveFieldByFieldElementComparator(configuration)
                               .contains(other);
  }
