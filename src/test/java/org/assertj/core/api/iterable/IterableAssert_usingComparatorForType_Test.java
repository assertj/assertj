...
class IterableAssert_usingComparatorForType_Test extends IterableAssertBaseTest {
  ...
  void should_only_use_comparator_on_fields_element_but_not_the_element_itself() {
    ...
    then(error).hasMessage(format("%nExpecting ArrayList:%n"
                                  ...
                                  + "Comparators used:%n"
                                  + "- for elements fields (by type): {Double -> DoubleComparator[precision=1.0E-15], Float -> FloatComparator[precision=1.0E-6], String -> AlwaysEqualComparator, Path -> lexicographic comparator (Path naturalComparator)}%n"
  ...
  void should_fail_because_of_comparator_set_last() {
    ...
    then(error).hasMessage(format("%nExpecting ArrayList:%n"
                                  ...
                                  + "Comparators used:%n"
                                  + "- for elements fields (by type): {Double -> DoubleComparator[precision=1.0E-15], Float -> FloatComparator[precision=1.0E-6], String -> org.assertj.core.test.NeverEqualComparator, Path -> lexicographic comparator (Path naturalComparator)}%n"
                                  + "- for elements (by type): {Double -> DoubleComparator[precision=1.0E-15], Float -> FloatComparator[precision=1.0E-6], String -> AlwaysEqualComparator, Path -> lexicographic comparator (Path naturalComparator)}"));
