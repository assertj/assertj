...
public class IterableAssert_usingElementComparatorOnFields_Test extends IterableAssertBaseTest {
  ...
  @Test
  public void should_be_able_to_use_a_comparator_for_specified_fields_of_elments_when_using_element_comparator_on_fields() {
    Jedi actual = new Jedi("Yoda", "green");
    Jedi other = new Jedi("Luke", "green");

    assertThat(singletonList(actual)).usingComparatorForElementFieldsWithName(new AlwaysEqualStringComparator(), "name")
                                     .usingElementComparatorOnFields("name", "lightSaberColor").contains(other);
  }
