...
/**
 * Tests for <code>{@link org.assertj.core.api.IntArrayAssert#containsExactlyInAnyOrder(Integer[])}</code>.
 *
 * @author Omar Morales Ortega
 */
@DisplayName("IntArrayAssert containsExactlyInAnyOrder(Integer[])")
public class IntArrayAssert_containsExactlyInAnyOrder_with_Integer_array_Test extends IntArrayAssertBaseTest {
