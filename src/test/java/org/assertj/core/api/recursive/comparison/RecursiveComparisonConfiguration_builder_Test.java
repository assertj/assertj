...
public class RecursiveComparisonConfiguration_builder_Test {
  ...
  public void should_set_ignoredFieldsRegexes() {
    ...
    // WHEN
    RecursiveComparisonConfiguration configuration = RecursiveComparisonConfiguration.builder()
                                                                                     .withIgnoredFieldsRegexes(values)
                                                                                     .build();
    // THEN
  ...
  public void should_set_ignoredOverriddenEqualsRegexes() {
    ...
    // WHEN
    RecursiveComparisonConfiguration configuration = RecursiveComparisonConfiguration.builder()
                                                                                     .withIgnoredOverriddenEqualsRegexes(values)
                                                                                     .build();
    // THEN
    then(configuration.getIgnoredOverriddenEqualsRegexes()).extracting(Pattern::pattern)
                                                           .containsExactly(values);
  }
  ...
  public void should_set_comparatorForField() {
    ...
    // WHEN
    RecursiveComparisonConfiguration configuration = RecursiveComparisonConfiguration.builder()
                                                                                     .withComparatorForField(alwaysEqualComparator,
                                                                                                             fooLocation)
                                                                                     .build();
    // THEN
    then(configuration.hasComparatorForField(fooLocation.getFieldPath())).isTrue();
    then(configuration.getComparatorForField(fooLocation.getFieldPath())).isSameAs(alwaysEqualComparator);
  }
