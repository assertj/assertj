...
public class BigIntegerAssert_isPositive_Test extends BigIntegerAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(bigIntegers).assertIsPositive(getInfo(assertions), getActual(assertions));
  }
}
