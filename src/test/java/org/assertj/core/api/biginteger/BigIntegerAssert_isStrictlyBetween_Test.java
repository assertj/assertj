...
public class BigIntegerAssert_isStrictlyBetween_Test extends BigIntegerAssertBaseTest {

  @Override
  protected BigIntegerAssert invoke_api_method() {
    return assertions.isStrictlyBetween(new BigInteger("6"), new BigInteger("8"));
  }
