...
public class BigIntegerAssert_isNotEqualByComparingToWithStringParameter_Test extends BigIntegerAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(comparables).assertNotEqualByComparison(getInfo(assertions), getActual(assertions), new BigInteger(ONE_AS_STRING));
  }
