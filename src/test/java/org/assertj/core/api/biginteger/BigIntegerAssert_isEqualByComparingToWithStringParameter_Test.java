...
public class BigIntegerAssert_isEqualByComparingToWithStringParameter_Test extends BigIntegerAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(comparables).assertEqualByComparison(getInfo(assertions), getActual(assertions), new BigInteger(ONE_AS_STRING));
  }
}
