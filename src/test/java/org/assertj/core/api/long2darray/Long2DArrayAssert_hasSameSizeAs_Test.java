...
/**
 * Tests for <code>{@link Long2DArrayAssert#hasSameSizeAs(Object)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Long2DArrayAssert hasSameSizeAs")
class Long2DArrayAssert_hasSameSizeAs_Test extends Long2DArrayAssertBaseTest {
