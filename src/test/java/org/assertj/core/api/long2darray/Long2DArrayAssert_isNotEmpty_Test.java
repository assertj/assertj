...
/**
 * Tests for <code>{@link Long2DArrayAssert#isNotEmpty()}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Long2DArrayAssert isNotEmpty")
class Long2DArrayAssert_isNotEmpty_Test extends Long2DArrayAssertBaseTest {
