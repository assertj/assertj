...
public class OptionalDoubleAssert_hasValue_Test extends BaseTest {
    ...
    @Test
    public void should_pass_if_optionaldouble_has_expected_value() throws Exception {
        assertThat(OptionalDouble.of(10.0)).hasValue(10.0);
    }

    @Test
    public void should_fail_if_optionaldouble_does_not_have_expected_value() throws Exception {
