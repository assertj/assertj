 ...
 */
public class OffsetDateTimeAssert_isAfterOrEqualTo_Test extends AbstractOffsetDateTimeAssertBaseTest {
  ...
  @Test
  public void should_fail_if_given_offsetdatetime_is_null() {
    assertThatIllegalArgumentException().isThrownBy(() -> assertions.isAfterOrEqualTo((OffsetDateTime) null))
  ...
  public void should_fail_if_given_string_parameter_is_null() {
    assertThatIllegalArgumentException().isThrownBy(() -> assertions.isAfterOrEqualTo((String) null))
