...
/**
 * Tests for <code>{@link Double2DArrayAssert#hasSameSizeAs(Object)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Double2DArrayAssert hasSameSizeAs")
class Double2DArrayAssert_hasSameSizeAs_Test extends Double2DArrayAssertBaseTest {
