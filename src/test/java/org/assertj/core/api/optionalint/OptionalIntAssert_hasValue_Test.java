...
public class OptionalIntAssert_hasValue_Test extends BaseTest {
    ...
    @Test
    public void should_fail_when_OptionalInt_is_null() throws Exception {
    ...
    @Test
    public void should_pass_if_OptionalInt_has_expected_value() throws Exception {
        assertThat(OptionalInt.of(10)).hasValue(10);
    }

    @Test
    public void should_fail_if_OptionalInt_does_not_have_expected_value() throws Exception {
