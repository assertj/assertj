...
public class AbstractAssert_asDouble_Test {

  @Test
  public void should_allow_to_perform_Double_assertions_on_Double_variable_declared_as_Object() {
    Object doubleAsObject = -1.0D;
    assertThat(doubleAsObject).asDouble().isNegative();
  }
  ...
  public void should_fail_as_variable_runtime_type_is_not_Double() {
    ...
    // WHEN
    try {
      assertThat(greatAuthor).asDouble().isNegative();
