...
public class AbstractAssert_asBooleanArray_Test {

  @Test
  public void should_allow_to_perform_Boolean_assertions_on_Boolean_variable_declared_as_Object() {
    Object booleanAsObject = new boolean[] {true, false};
    assertThat(booleanAsObject).asBooleanArray().contains(true);
  }
  ...
  public void should_fail_as_variable_runtime_type_is_not_Boolean() {
    ...
    // WHEN
    try {
      assertThat(greatAuthor).asBooleanArray().contains(true);
