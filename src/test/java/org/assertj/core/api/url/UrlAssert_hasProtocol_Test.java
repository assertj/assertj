 ...
 */
public class UrlAssert_hasProtocol_Test extends UrlAssertBaseTest {
  private String expected = "http";

  @Override
  protected UrlAssert invoke_api_method() {
    return assertions.hasProtocol(expected);
  }

  @Override
  protected void verify_internal_effects() {
    verify(urls).assertHasProtocol(getInfo(assertions), getActual(assertions), expected);
  }
}
