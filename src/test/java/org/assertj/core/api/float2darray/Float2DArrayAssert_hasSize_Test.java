...
/**
 * Tests for <code>{@link Float2DArrayAssert#hasSize(int, int)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Float2DArrayAssert hasSize")
class Float2DArrayAssert_hasSize_Test extends Float2DArrayAssertBaseTest {
