...
/**
 * Tests for <code>{@link Float2DArrayAssert#hasSameSizeAs(Object)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Float2DArrayAssert hasSameSizeAs")
class Float2DArrayAssert_hasSameSizeAs_Test extends Float2DArrayAssertBaseTest {
