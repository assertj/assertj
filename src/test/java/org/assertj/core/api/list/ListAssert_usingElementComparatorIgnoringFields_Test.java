...
public class ListAssert_usingElementComparatorIgnoringFields_Test extends ListAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    ...
    assertThat(listsElementComparator).isInstanceOf(ExtendedByTypeComparator.class);
    assertThat(((IgnoringFieldsComparator) ((ExtendedByTypeComparator) listsElementComparator)
    ...
    assertThat(iterablesElementComparator).isInstanceOf(ExtendedByTypeComparator.class);
    assertThat(((IgnoringFieldsComparator) ((ExtendedByTypeComparator) iterablesElementComparator)
      .getComparator()).getFields()).containsOnly("field");
  }
