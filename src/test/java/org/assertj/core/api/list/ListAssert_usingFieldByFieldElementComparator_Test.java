...
public class ListAssert_usingFieldByFieldElementComparator_Test extends ListAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    ...
    Comparator<?> listsElementComparator = ((ExtendedByTypeComparator) ((ComparatorBasedComparisonStrategy) lists
    ...
    Comparator<?> iterablesElementComparator = ((ExtendedByTypeComparator) ((ComparatorBasedComparisonStrategy)
