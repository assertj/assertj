...
public class ListAssert_usingElementComparatorOnFields_Test extends ListAssertBaseTest {
    ...
    protected void verify_internal_effects() {
        ...
        assertArrayEquals(new String[]{"field"}, ((OnFieldsComparisonStrategy) getLists(assertions).getComparisonStrategy()).getFieldsNames());
        assertTrue(getIterables(assertions).getComparisonStrategy() instanceof OnFieldsComparisonStrategy);
        assertArrayEquals(new String[]{"field"}, ((OnFieldsComparisonStrategy) getIterables(assertions).getComparisonStrategy()).getFieldsNames());
    }
