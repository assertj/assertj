...
class LongAdderAssert_hasValueCloseTo_Test extends LongAdderAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(longs).assertIsCloseTo(getInfo(assertions), getActual(assertions).sum(), 7L, within(3L));
  }
}
