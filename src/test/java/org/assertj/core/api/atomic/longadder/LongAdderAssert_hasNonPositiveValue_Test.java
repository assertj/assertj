...
class LongAdderAssert_hasNonPositiveValue_Test extends LongAdderAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(longs).assertIsNotPositive(getInfo(assertions), getActual(assertions).sum());
  }
}
