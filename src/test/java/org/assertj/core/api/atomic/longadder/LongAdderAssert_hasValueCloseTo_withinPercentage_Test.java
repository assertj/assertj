...
class LongAdderAssert_hasValueCloseTo_withinPercentage_Test extends LongAdderAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(longs)
      .assertIsCloseToPercentage(getInfo(assertions), getActual(assertions).sum(), 10L, withinPercentage(20));
  }
}
