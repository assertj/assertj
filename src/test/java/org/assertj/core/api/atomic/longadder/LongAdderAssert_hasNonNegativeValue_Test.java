...
class LongAdderAssert_hasNonNegativeValue_Test extends LongAdderAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(longs).assertIsNotNegative(getInfo(assertions), getActual(assertions).sum());
  }
}
