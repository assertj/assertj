...
class LongAdderAssert_hasValueBetween_Test extends LongAdderAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(longs).assertIsBetween(getInfo(assertions), getActual(assertions).sum(), 6L, 8L);
  }
}
