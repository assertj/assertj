...
public class AtomicLongAssert_hasValueCloseTo_Test extends AtomicLongAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(longs).assertIsCloseTo(getInfo(assertions), getActual(assertions).get(), 7L, within(3L));
  }
}
