...
public class CompletableFutureAssert_isCompletedWith_Test extends BaseTest {

  @Test
  public void should_pass_if_completable_future_is_completed() throws Exception {
    assertThat(CompletableFuture.completedFuture("done")).isCompletedWith("done");
  }

  @Test
  public void should_fail_when_completable_future_is_null() throws Exception {
    assertThatThrownBy(() -> assertThat((CompletableFuture<String>) null).isCompletedWith("done"))
  ...
  public void should_fail_if_result_does_not_match() throws Exception {
    ...
    assertThatThrownBy(() -> assertThat(future).isCompletedWith("foo"))
        .isInstanceOf(AssertionError.class)
  ...
  public void should_fail_if_completable_future_is_incomplete() throws Exception {
    ...
    assertThatThrownBy(() -> assertThat(future).isCompletedWith("done"))
        .isInstanceOf(AssertionError.class)
