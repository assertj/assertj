...
public class CompletableFutureAssert_isNotCompletedExceptionally_Test extends BaseTest {
  ...
  @Test
  public void should_pass_if_completable_future_is_completed_exceptionally() throws Exception {
  ...
  public void should_fail_when_completable_future_is_null() throws Exception {
    assertThatThrownBy(() -> assertThat((CompletableFuture<String>) null).isNotCompletedExceptionally())
        .isInstanceOf(AssertionError.class)
        .hasMessage(format(actualIsNull()));
  }

  @Test
  public void should_fail_if_completable_future_is_not_completed_exceptionally() throws Exception {
    CompletableFuture<String> future = new CompletableFuture<>();
    future.completeExceptionally(new RuntimeException());

    assertThatThrownBy(() -> assertThat(future).isNotCompletedExceptionally())
        .isInstanceOf(AssertionError.class)
        .hasMessage(shouldNotHaveCompletedExceptionally(future).create());
  }
}
