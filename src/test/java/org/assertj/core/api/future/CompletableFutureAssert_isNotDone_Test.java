...
public class CompletableFutureAssert_isNotDone_Test extends BaseTest {
  ...
  @Test
  public void should_pass_if_completable_future_is_not_done() throws Exception {
	  assertThat(new CompletableFuture<>()).isNotDone();
  }

  @Test
  public void should_fail_when_completable_future_is_null() throws Exception {
    assertThatThrownBy(() -> assertThat((CompletableFuture<String>) null).isNotDone())
        .isInstanceOf(AssertionError.class)
        .hasMessage(format(actualIsNull()));
  }

  @Test
  public void should_fail_if_completable_future_is_done() throws Exception {
    CompletableFuture<String> future = CompletableFuture.completedFuture("done");

    assertThatThrownBy(() -> assertThat(future).isNotDone())
        .isInstanceOf(AssertionError.class)
