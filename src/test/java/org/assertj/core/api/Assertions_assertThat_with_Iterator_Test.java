...
public class Assertions_assertThat_with_Iterator_Test {
  ...
  public void should_create_Assert() {
    AbstractIterableAssert<?, Iterable<Object>, Object> assertions = Assertions.assertThat(newLinkedHashSet());
  ...
  public void should_initialise_actual() {
    ...
    AbstractIterableAssert<?, Iterable<String>, String> assertions = assertThat(names);
    assertThat(assertions.actual, hasItems("Leia", "Luke"));
  }

  @Test
  public void should_allow_null() {
    AbstractIterableAssert<?, Iterable<String>, String> assertions = assertThat((Iterator<String>) null);
