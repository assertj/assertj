...
/**
 * Tests for <code>{@link Int2DArrayAssert#isEmpty()}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Int2DArrayAssert isEmpty")
class Int2DArrayAssert_isEmpty_Test extends Int2DArrayAssertBaseTest {
