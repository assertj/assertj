 ...
 */
@DisplayName("Int2DArrayAssert isDeepEqualTo")
class Int2DArrayAssert_isDeepEqualTo_Test {
  ...
  void should_fail_if_one_value_in_second_dimension_is_different() {
    ...
    then(assertionError).hasMessage(shouldBeEqual.newAssertionError(emptyDescription(), STANDARD_REPRESENTATION).getMessage());
  }
}
