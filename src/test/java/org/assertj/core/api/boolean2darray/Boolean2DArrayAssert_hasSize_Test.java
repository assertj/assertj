...
/**
 * Tests for <code>{@link Boolean2DArrayAssert#hasSize(int, int)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Boolean2DArrayAssert hasSize")
class Boolean2DArrayAssert_hasSize_Test extends Boolean2DArrayAssertBaseTest {
