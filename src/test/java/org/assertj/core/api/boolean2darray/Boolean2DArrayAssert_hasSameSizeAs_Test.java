...
/**
 * Tests for <code>{@link Boolean2DArrayAssert#hasSameSizeAs(Object)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Boolean2DArrayAssert hasSameSizeAs")
class Boolean2DArrayAssert_hasSameSizeAs_Test extends Boolean2DArrayAssertBaseTest {
