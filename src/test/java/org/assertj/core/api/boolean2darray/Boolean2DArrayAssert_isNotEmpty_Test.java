...
/**
 * Tests for <code>{@link Boolean2DArrayAssert#isNotEmpty()}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Boolean2DArrayAssert isNotEmpty")
class Boolean2DArrayAssert_isNotEmpty_Test extends Boolean2DArrayAssertBaseTest {
