...
public class Assertions_sync_assertThatIndexOutOfBoundsException_with_BDDAssertions_and_WithAssertions_Test extends BaseAssertionsTest {

  @Test
  void Assertions_assertThatIndexOutOfBoundsException_and_BDDAssertions_thenIndexOutOfBoundsException_should_be_the_same() {
    Method[] assertThatIndexOutOfBoundsExceptionInAssertions = findMethodsWithName(Assertions.class, "assertThatIndexOutOfBoundsException");
    Method[] thenIndexOutOfBoundsExceptionInBDDAssertions = findMethodsWithName(BDDAssertions.class, "thenIndexOutOfBoundsException");
  ...
  void Assertions_assertThatIndexOutOfBoundsException_and_WithAssertions_assertThatIndexOutOfBoundsException_should_be_the_same() {
    Method[] assertThatIndexOutOfBoundsExceptionInAssertions = findMethodsWithName(Assertions.class, "assertThatIndexOutOfBoundsException");
    Method[] assertThatIndexOutOfBoundsExceptionInWithAssertions = findMethodsWithName(WithAssertions.class, "assertThatIndexOutOfBoundsException");
