...
public class Assertions_assertThat_asHex_Test {
  ...
  @Test
  public void should_assert_signed_byte_as_hex() {
  ...
  @Test
  public void should_assert_bytes_contains_as_hex() {
    thrown.expectMessage("Expecting:\n" +
        ...
        "but could not find:\n" +
        " <[0x01]>");
    assertThat(new byte[]{2, 3}).asHex().contains(new byte[]{1});
  }
  ...
  @Test
  public void should_assert_signed_short_as_hex() {
    thrown.expectMessage("expected:<0x[0003]> but was:<0x[FFFE]>");
    assertThat((short) -2).asHex().isEqualTo((short) 3);
  }

  @Test
  public void should_assert_shorts_as_hex() {
    thrown.expectMessage("expected:<[0x000[3]]> but was:<[0x000[1, 0x0002]]>");
    assertThat(new short[]{(short) 1, (short) 2}).asHex().isEqualTo(new short[]{(short) 3});
  }
  ...
  @Test
  public void should_assert_integers_as_hex() {
    thrown.expectMessage("expected:<[0x0000_000[]2]> but was:<[0x0000_000[1, 0x0000_000]2]>");
    assertThat(new int[]{1, 2}).asHex().isEqualTo(new int[]{2});
  }
  ...
  public void should_assert_Date_as_hex() throws ParseException {
    ...
    assertThat(toDate("26/08/1994")).asHex().isEqualTo(toDate("26/08/1997"));
  }
