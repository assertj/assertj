...
public class Assertions_sync_assertThatReflectiveOperationException_with_BDDAssertions_and_WithAssertions_Test extends BaseAssertionsTest {
  ...
  void Assertions_assertThatReflectiveOperationException_and_BDDAssertions_thenReflectiveOperationException_should_be_the_same() {
    Method[] assertThatReflectiveOperationExceptionInAssertions = findMethodsWithName(Assertions.class, "assertThatReflectiveOperationException");
    Method[] thenReflectiveOperationExceptionInBDDAssertions = findMethodsWithName(BDDAssertions.class, "thenReflectiveOperationException");
  ...
  void Assertions_assertThatReflectiveOperationException_and_WithAssertions_assertThatReflectiveOperationException_should_be_the_same() {
    Method[] assertThatReflectiveOperationExceptionInAssertions = findMethodsWithName(Assertions.class, "assertThatReflectiveOperationException");
    Method[] assertThatReflectiveOperationExceptionInWithAssertions = findMethodsWithName(WithAssertions.class, "assertThatReflectiveOperationException");
