...
/**
 * Tests for <code>{@link Short2DArrayAssert#isNotEmpty()}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Short2DArrayAssert isNotEmpty")
class Short2DArrayAssert_isNotEmpty_Test extends Short2DArrayAssertBaseTest {
