...
/**
 * Tests for <code>{@link Short2DArrayAssert#hasSize(int, int)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Short2DArrayAssert hasSize")
class Short2DArrayAssert_hasSize_Test extends Short2DArrayAssertBaseTest {
