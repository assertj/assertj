...
/**
 * Tests for <code>{@link Short2DArrayAssert#hasSameSizeAs(Object)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Short2DArrayAssert hasSameSizeAs")
class Short2DArrayAssert_hasSameSizeAs_Test extends Short2DArrayAssertBaseTest {
