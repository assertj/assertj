...
/**
 * Tests for <code>{@link Short2DArrayAssert#hasSameDimensionsAs(Object)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Short2DArrayAssert hasSameDimensionsAs")
class Short2DArrayAssert_hasSameDimensionsAs_Test extends Short2DArrayAssertBaseTest {
