...
/**
 * Tests for <code>{@link Byte2DArrayAssert#hasSize(int, int)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Byte2DArrayAssert hasSize")
class Byte2DArrayAssert_hasSize_Test extends Byte2DArrayAssertBaseTest {
