...
/**
 * Tests for <code>{@link Byte2DArrayAssert#hasSameSizeAs(Object)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Byte2DArrayAssert hasSameSizeAs")
class Byte2DArrayAssert_hasSameSizeAs_Test extends Byte2DArrayAssertBaseTest {
