...
/**
 * Tests for <code>{@link Byte2DArrayAssert#isNullOrEmpty()}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Byte2DArrayAssert isNullOrEmpty")
class Byte2DArrayAssert_isNullOrEmpty_Test extends Byte2DArrayAssertBaseTest {
