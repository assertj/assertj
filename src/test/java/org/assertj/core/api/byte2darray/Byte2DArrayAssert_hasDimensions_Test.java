...
/**
 * Tests for <code>{@link Byte2DArrayAssert#hasDimensions(int, int)}</code>.
 * 
 * @author Maciej Wajcht
 */
@DisplayName("Byte2DArrayAssert hasDimensions")
class Byte2DArrayAssert_hasDimensions_Test extends Byte2DArrayAssertBaseTest {
