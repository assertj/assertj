...
import org.assertj.core.assertions.error.ElementsShouldNotBeAtLeast;
...
public class ElementsShouldNotBeExactly_create_Test {
  ...
  @Before
  public void setUp() {
    factory = elementsShouldNotBeAtLeast(newArrayList("Yoda", "Solo", "Leia"), 2, new TestCondition<String>("Not a Jedi"));
  }
