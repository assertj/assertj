...
import org.assertj.core.assertions.error.ElementsShouldNotHaveAtLeast;
...
public class ElementsShouldNotHaveAtLeast_create_Test {
  ...
  @Before
  public void setUp() {
    factory = elementsShouldNotHaveAtLeast(newArrayList("Yoda", "Luke", "Leia"), 2, new TestCondition<String>("Jedi power"));
  }
