...
import org.assertj.core.assertions.error.ShouldNotBeNull;
import org.assertj.core.assertions.internal.TestDescription;
import org.junit.*;

/**
 * Tests for <code>{@link ShouldNotBeNull#create(Description)}</code>.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class ShouldNotBeNull_create_Test {
  ...
  public void should_create_error_message() {
    ...
    assertEquals("[Test] expecting actual not to be null", message);
  }
}
