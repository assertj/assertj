...
class ShouldHaveSizeGreaterThanOrEqualTo_create_Test {
  ...
  void should_create_error_message() {
    ...
    assertThat(message).isEqualTo(String.format("[Test] %nExpected size to be greater than or equal to:<2> but was:<4> in:%n<['a', 'b']>"));
  }
  ...
  void should_create_error_message_with_hexadecimal_representation() {
    ...
    assertThat(message).isEqualTo(String.format("[Test] %nExpected size to be greater than or equal to:<2> but was:<4> in:%n<['0x0061', '0x0062']>"));
  }
}
