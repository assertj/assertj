...
/**
 * Tests for
 * <code>{@link ShouldHaveAnnotation#shouldHaveAnnotation(Class, java.util.Collection, java.util.Collection)}}</code>
 * 
 * @author William Delanoue
 */
public class ShouldHaveAnnotation_create_Test {

  private ErrorMessageFactory factory;

  @Before
  public void setUp() {
    factory = shouldHaveAnnotation(ShouldHaveAnnotation_create_Test.class,
  ...
  public void should_create_error_message() {
    ...
    Assertions.assertThat(message).isEqualTo(
        "[Test] \n" + "Expecting\n" + " <org.assertj.core.error.ShouldHaveAnnotation_create_Test>\n"
