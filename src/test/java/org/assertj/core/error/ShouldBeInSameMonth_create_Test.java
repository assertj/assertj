...
/**
 * Tests for <code>{@link ShouldBeInSameMonth#create(org.assertj.core.description.Description, org.assertj.core.presentation.Representation)}</code>.
 * 
...
public class ShouldBeInSameMonth_create_Test {
  ...
  public void should_create_error_message() {
    ...
    assertEquals(String.format("[Test] %nExpecting:%n <2010-01-01T00:00:00>%nto be on same year and month as:%n <2010-02-01T00:00:00>"), message);
  }
