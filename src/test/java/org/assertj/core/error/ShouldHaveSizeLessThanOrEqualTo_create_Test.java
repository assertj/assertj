...
public class ShouldHaveSizeLessThanOrEqualTo_create_Test {
  ...
  void should_create_error_message() {
    ...
    assertThat(message).isEqualTo(format("[Test] %nExpecting size of:%n <2>%nto be less than or equal to:<4> but was:<\"ab\">"));
  }
  ...
  void should_create_error_message_with_hexadecimal_representation() {
    ...
    assertThat(message).isEqualTo(format("[Test] %nExpecting size of:%n <2>%nto be less than or equal to:<4> but was:<\"['0x0061', '0x0062']\">"));
  }
}
