...
public class ShouldContainOnlyNulls_create_Test {
  ...
  public void should_create_error_message_with_unexpected_element() {
    ErrorMessageFactory factory = ShouldContainOnlyNulls.shouldContainOnlyNulls(newArrayList("person", null), newArrayList("person"));
  ...
  public void should_create_error_message_with_no_any_element() {
    ErrorMessageFactory factory = ShouldContainOnlyNulls.shouldContainOnlyNulls(newArrayList(), newArrayList());
    String message = factory.create(new TextDescription("Test"), new StandardRepresentation());
