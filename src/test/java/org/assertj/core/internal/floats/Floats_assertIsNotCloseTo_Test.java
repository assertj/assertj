...
public class Floats_assertIsNotCloseTo_Test extends FloatsBaseTest {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    floats.assertIsNotCloseTo(someInfo(), null, ONE, within(ONE));
  }

  @Test(expected = NullPointerException.class)
  public void should_fail_if__expected_value_is_null() {
    floats.assertIsNotCloseTo(someInfo(), ONE, null, within(ONE));
  }
  ...
  public void should_pass_if_difference_is_equal_to_given_offset() {
    floats.assertIsNotCloseTo(someInfo(), ONE, ONE, within(ZERO));
    floats.assertIsNotCloseTo(someInfo(), ONE, ZERO, within(ONE));
    floats.assertIsNotCloseTo(someInfo(), ONE, TWO, within(ONE));
  }
