...
import static org.assertj.core.error.ShouldHaveLinesCount.shouldHaveLinesCount;
...
/**
 * Tests for <code>{@link org.assertj.core.internal.Strings#assertHasLinesCount(org.assertj.core.api.AssertionInfo, CharSequence, int)}</code>.
 *
...
public class Strings_assertHasLinesCount_Test extends StringsBaseTest {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    strings.assertHasLinesCount(someInfo(), null, 3);
  }
  ...
  public void should_fail_if_lines_count_of_actual_is_not_equal_to_expected_size() {
    ...
    try {
      strings.assertHasLinesCount(info, actual, 6);
  ...
  public void should_pass_if_lines_count_of_actual_is_equal_to_expected_lines_count() {
    strings.assertHasLinesCount(someInfo(), "Begin" + LINE_SEPARATOR + "Middle\nEnd", 3);
  }

  @Test
  public void should_fail_if_actual_is_null_whatever_custom_comparison_strategy_is() {
    thrown.expectAssertionError(actualIsNull());
    stringsWithCaseInsensitiveComparisonStrategy.assertHasLinesCount(someInfo(), null, 3);
  }
  ...
  public void should_fail_if_lines_count_of_actual_is_not_equal_to_expected_lines_count_whatever_custom_comparison_strategy_is() {
    ...
    String actual = "Begin" + LINE_SEPARATOR + "End";
    try {
      stringsWithCaseInsensitiveComparisonStrategy.assertHasLinesCount(info, actual, 3);
    } catch (AssertionError e) {
  ...
  public void should_pass_if_lines_count_of_actual_is_equal_to_expected_lines_count_whatever_custom_comparison_strategy_is() {
    stringsWithCaseInsensitiveComparisonStrategy.assertHasLinesCount(someInfo(), "Begin" + LINE_SEPARATOR + "End", 2);
  }
}
