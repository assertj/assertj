...
/**
 * Tests for {@link Throwables#assertHasStackTrace(AssertionInfo, Throwable)}.
 *
 * @author Ashley Scopes
 */
class Throwables_assertHasStackTrace_Test extends ThrowablesBaseTest {
  @Test
  void should_fail_if_actual_is_null() {
    ...
    // THEN
    assertThatThrownBy(() -> throwables.assertHasStackTrace(someInfo(), actual))
  ...
  @Test
  void should_fail_if_stack_trace_is_not_present() {
    // GIVEN
    ...
    assertThatThrownBy(() -> throwables.assertHasStackTrace(someInfo(), actual))
      .isInstanceOf(AssertionError.class)
      .hasMessage(shouldHaveStackTrace(actual).create());
  }

  @Test
  void should_succeed_if_stack_trace_is_present() {
    // GIVEN
    Throwable actual = new Throwable("Blah blah").fillInStackTrace();

    // THEN
    assertThatCode(() -> throwables.assertHasStackTrace(someInfo(), actual))
