...
public class InputStreams_assertHasContent_Test extends InputStreamsBaseTest {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    inputStreams.assertHasContent(someInfo(), null, "");
  }
  ...
  public void should_throw_error_wrapping_catched_IOException() throws IOException {
    ...
    when(diff.diff(actual, expectedString)).thenThrow(cause);
  ...
  public void should_fail_if_inputstream_and_string_do_not_have_equal_content() throws IOException {
    ...
    when(diff.diff(actual, expectedString)).thenReturn(diffs);
    AssertionInfo info = someInfo();
    try {
      inputStreams.assertHasContent(info, actual, expectedString);
