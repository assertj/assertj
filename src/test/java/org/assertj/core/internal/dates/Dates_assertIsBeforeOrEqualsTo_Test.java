...
public class Dates_assertIsBeforeOrEqualsTo_Test extends DatesBaseTest {
  ...
  public void should_throw_error_if_given_date_is_null() {
    assertThatNullPointerException().isThrownBy(() -> dates.assertIsBeforeOrEqualsTo(someInfo(), actual, null))
                                    .withMessage(dateToCompareActualWithIsNull());
  }

  @Test
  public void should_fail_if_actual_is_null() {
    assertThatExceptionOfType(AssertionError.class).isThrownBy(() -> dates.assertIsBeforeOrEqualsTo(someInfo(), null, parseDate("2010-01-01")))
  ...
  public void should_throw_error_if_given_date_is_null_whatever_custom_comparison_strategy_is() {
    assertThatNullPointerException().isThrownBy(() -> datesWithCustomComparisonStrategy.assertIsBeforeOrEqualsTo(someInfo(),
                                                                                                                 actual,
                                                                                                                 null))
                                    .withMessage(dateToCompareActualWithIsNull());
  }
  ...
  public void should_fail_if_actual_is_null_whatever_custom_comparison_strategy_is() {
    assertThatExceptionOfType(AssertionError.class).isThrownBy(() -> datesWithCustomComparisonStrategy.assertIsBeforeOrEqualsTo(someInfo(), null, parseDate("2010-01-01")))
                                                   .withMessage(actualIsNull());
  }
