 ...
 * <p>
 * Is in <code>org.fest.assertions.internal</code> package to be able to set {@link ObjectArrays#failures}
 * appropriately.
 * 
...
public class ObjectArraysBaseTest {
  ...
  public void setUp() {
    ...
    caseInsensitiveStringComparisonStrategy = new ComparatorBasedComparisonStrategy(
