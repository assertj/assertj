...
/**
 * Tests for <code>{@link org.assertj.core.internal.Uris#assertHasHost(org.assertj.core.api.AssertionInfo, java.net.URI, String)}</code>.
 *
...
public class Uris_assertHasHost_Test extends UrisBaseTest {
    ...
    public void should_fail_if_actual_is_null() {
        ...
        uris.assertHasHost(info, null, "http://www.helloworld.org");
    }
    ...
    @Test
    public void should_pass_if_actual_uri_has_the_given_host_with_pages() throws URISyntaxException {
    ...
    public void should_throw_error_if_actual_uri_has_no_scheme() throws URISyntaxException {
        ...
        uris.assertHasHost(info, new URI("helloworld.org/pages"), "helloworld.org");
    }

    @Test
    public void should_throw_error_if_urisyntax_is_not_valid() throws URISyntaxException {
        thrown.expect(URISyntaxException.class);
        uris.assertHasHost(info, new URI("http://finance.yahoo.com/q/h?s=^IXIC"), "http");
    }
}
