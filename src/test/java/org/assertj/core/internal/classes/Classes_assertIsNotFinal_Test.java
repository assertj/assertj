...
public class Classes_assertIsNotFinal_Test extends ClassesBaseTest {
  ...
  @Test
  public void should_pass_if_actual_is_not_final_class() {
    actual = Throwable.class;
    classes.assertIsNotFinal(someInfo(), actual);
  }

  @Test()
  public void should_fail_if_actual_is_final_class() {
    AssertionInfo info = someInfo();
    actual = String.class;
    try {
      classes.assertIsNotFinal(someInfo(), actual);
    } catch (AssertionError e) {
      verify(failures).failure(info, shouldNotBeFinal(actual));
      return;
    }
