...
/**
 * Tests for <code>{@link Float2DArrays#assertHasDimensions(AssertionInfo, float[][], int, int)}</code>.
 *
 * @author Maciej Wajcht
 */
public class Float2DArrays_assertHasDimensions_Test extends Float2DArraysBaseTest {

  @Test
  public void should_delegate_to_Arrays2D() {
    // WHEN
    float2dArrays.assertHasDimensions(info, actual, 2, 3);
    // THEN
