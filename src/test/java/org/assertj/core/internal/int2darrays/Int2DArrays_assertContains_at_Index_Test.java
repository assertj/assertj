...
public class Int2DArrays_assertContains_at_Index_Test extends Int2DArraysBaseTest {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    // WHEN
    AssertionError assertionError = expectAssertionError(() -> arrays.assertContains(someInfo(), actual, expectedElement, someIndex()));
    // THEN
  ...
  public void should_fail_if_actual_does_not_contain_value_at_index() {
    ...
    // WHEN
    AssertionError assertionError = expectAssertionError(() -> arrays.assertContains(someInfo(), actual, new int[] {0, 2, 4}, index));
    // THEN
