...
/**
 * Tests for <code>{@link Object2DArrays#assertNullOrEmpty(AssertionInfo, Object[][])}</code>.
 *
 * @author Maciej Wajcht
 */
public class Object2DArrays_assertNullOrEmpty_Test extends Object2DArraysBaseTest {

  @Test
  public void should_delegate_to_Arrays2D() {
    // WHEN
    object2dArrays.assertNullOrEmpty(someInfo(), actual);
    // THEN
