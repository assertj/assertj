...
public class Doubles_assertIsNotCloseTo_Test extends DoublesBaseTest {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    doubles.assertIsNotCloseTo(someInfo(), null, ONE, within(ONE));
  }

  @Test(expected = NullPointerException.class)
  public void should_fail_if_expected_value_is_null() {
    doubles.assertIsNotCloseTo(someInfo(), ONE, null, within(ONE));
  }
  ...
  public void should_pass_if_difference_is_equal_to_given_offset() {
    doubles.assertIsNotCloseTo(someInfo(), ONE, ONE, within(ZERO));
    doubles.assertIsNotCloseTo(someInfo(), ONE, ZERO, within(ONE));
    doubles.assertIsNotCloseTo(someInfo(), ONE, TWO, within(ONE));
  }
