...
/**
 * Tests for <code>{@link Byte2DArrays#assertHasDimensions(AssertionInfo, byte[][], int, int)}</code>.
 *
 * @author Maciej Wajcht
 */
public class Byte2DArrays_assertHasDimensions_Test extends Byte2DArraysBaseTest {

  @Test
  public void should_delegate_to_Arrays2D() {
    // WHEN
    byte2dArrays.assertHasDimensions(info, actual, 2, 3);
    // THEN
