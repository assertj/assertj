...
/**
 * Tests for <code>{@link Byte2DArrays#assertNotEmpty(AssertionInfo, byte[][])}</code>.
 *
 * @author Maciej Wajcht
 */
public class Byte2DArrays_assertNotEmpty_Test extends Byte2DArraysBaseTest {

  @Test
  public void should_delegate_to_Arrays2D() {
    // WHEN
    byte2dArrays.assertNotEmpty(someInfo(), actual);
    // THEN
