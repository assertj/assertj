...
/**
 * Tests for <code>{@link Double2DArrays#assertHasDimensions(AssertionInfo, double[][], int, int)}</code>.
 *
 * @author Maciej Wajcht
 */
public class Double2DArrays_assertHasDimensions_Test extends Double2DArraysBaseTest {

  @Test
  public void should_delegate_to_Arrays2D() {
    // WHEN
    double2dArrays.assertHasDimensions(info, actual, 2, 3);
    // THEN
