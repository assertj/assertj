...
public class Iterables_assertAllSatisfy_Test extends IterablesBaseTest {
  ...
  private final List<String> actual = newArrayList("Luke", "Leia", "Yoda");
  ...
  public void should_fail_according_to_requirements() {
    ...
    try {
      ...
      verify(failures).failure(info, elementsShouldSatisfy(actual, "Yoda", String
        .format("%nExpecting:%n <\"Yoda\">%nto start with:%n <\"L\">%n")));
      return;
    }
  ...
  public void should_fail_if_consumer_is_null() {
    ...
    assertThat(actual).satisfies(null);
  }
}
