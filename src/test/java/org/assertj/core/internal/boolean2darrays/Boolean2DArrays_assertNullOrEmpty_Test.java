...
/**
 * Tests for <code>{@link Boolean2DArrays#assertNullOrEmpty(AssertionInfo, boolean[][])}</code>.
 *
 * @author Maciej Wajcht
 */
public class Boolean2DArrays_assertNullOrEmpty_Test extends Boolean2DArraysBaseTest {

  @Test
  public void should_delegate_to_Arrays2D() {
    // WHEN
    boolean2dArrays.assertNullOrEmpty(someInfo(), actual);
    // THEN
