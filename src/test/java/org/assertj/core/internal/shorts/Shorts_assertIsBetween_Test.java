...
public class Shorts_assertIsBetween_Test extends ShortsBaseTest {
  ...
  @Test
  public void should_pass_if_short_are_in_range() {
    shorts.assertIsBetween(someInfo(), ONE, ZERO, TEN);
  }

  @Test
  public void should_pass_if_short_are_in_range_inclusive_start() {
    shorts.assertIsBetween(someInfo(), ONE, ONE, TEN);
  }

  @Test
  public void should_pass_if_short_are_in_range_inclusive_end() {
    shorts.assertIsBetween(someInfo(), ONE, ZERO, ONE);
  }

  @Test
  public void should_fail_if_short_are_not_in_range_start() {
  ...
  @Test
  public void should_fail_if_short_are_not_in_range_end() {
    AssertionInfo info = someInfo();
    try {
