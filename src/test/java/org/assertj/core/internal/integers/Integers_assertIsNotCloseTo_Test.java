...
public class Integers_assertIsNotCloseTo_Test extends IntegersBaseTest {
  ...
  public void should_pass_if_difference_is_equal_to_given_offset() {
    integers.assertIsNotCloseTo(someInfo(), ONE, ONE, within(ZERO));
    integers.assertIsNotCloseTo(someInfo(), ONE, ZERO, within(ONE));
    integers.assertIsNotCloseTo(someInfo(), ONE, TWO, within(ONE));
  }
