...
/*
 * Tests for {@link Resources#contentOf(File, Charset)} and {@link Resources#contentOf(File, String)}.
 *
 * @author Turbo87
 * @author dorzey
 */
public class Resources_contentOf_Test {
  ...
  public void should_throw_exception_if_url_not_found() throws MalformedURLException {
    ...
    Resources.contentOf(missingFile.toURI().toURL(), Charset.defaultCharset());
  }

  @Test
  public void should_load_resource_from_url_using_charset() {
    // NB: UTF-8 must be supported by every Java implementation
    assertEquals(expectedContent, Resources.contentOf(sampleResourceURL, Charset.forName("UTF-8")));
  }

  @Test
  public void should_load_resource_from_url_using_charset_name() {
    assertEquals(expectedContent, Resources.contentOf(sampleResourceURL, "UTF-8"));
  }
}
