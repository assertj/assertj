...
public class NumberGrouping_Test {
  ...
  @Test
  public void should_group_words_in_byte_hex_value() throws Exception {
    String hexLiteral = NumberGrouping.toHexLiteral("CA");
    assertThat(hexLiteral).isEqualTo("CA");
  }

  @Test
  public void should_group_words_in_hex_value() throws Exception {
    String hexLiteral = NumberGrouping.toHexLiteral("01234567");
    assertThat(hexLiteral).isEqualTo("0123_4567");
  }

  @Test
  public void should_group_bytes_in_integer() throws Exception {
  ...
  @Test
  public void should_group_bytes_in_short() throws Exception {
