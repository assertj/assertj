...
public class Convert_Junit5_Assertions_To_Assertj_Test {
  ...
  public void Replace_Type_1() throws Exception {
    ...
    input = "assertEquals(  0,  multiParam( 1.1, param2).size());\n";
    expected = "assertThat(multiParam( 1.1, param2)).isEmpty();\n";
  ...
  public void Replace_Type_2() throws Exception {
    ...
    input += "assertEquals(12, multiParam(1.1,param2).size());\n";
    expected += "assertThat(multiParam(1.1,param2)).hasSize(12);\n";

    input += "assertEquals( 123, multiParam(1.1, param2, hello[i]).size());\n";
    expected += "assertThat(multiParam(1.1, param2, hello[i])).hasSize(123);\n";
  ...
  public void Replace_Type_4() throws Exception {
    ...
    input = "assertEquals(\"123,567.34\", StringHandling.fixFPNumberFormat(\"1,234,567.34\"));\n";
    expected = "assertThat(StringHandling.fixFPNumberFormat(\"1,234,567.34\")).isEqualTo(\"123,567.34\");\n";

    input += "assertEquals(\"123\\\",5\\\"67.34\", StringHandling.fixFPNumberFormat(\"1.234.567,34\"));\n";
    expected += "assertThat(StringHandling.fixFPNumberFormat(\"1.234.567,34\")).isEqualTo(\"123\\\",5\\\"67.34\");\n";
  ...
  public void Replace_Type_4B() throws Exception {
    ...
    input = "assertNotEquals(\"123,567.34\", StringHandling.fixFPNumberFormat(\"1,234,567.34\"));\n";
    expected = "assertThat(StringHandling.fixFPNumberFormat(\"1,234,567.34\")).isNotEqualTo(\"123,567.34\");\n";

    input += "assertNotEquals(\"123\\\",5\\\"67.34\", StringHandling.fixFPNumberFormat(\"1.234.567,34\"));\n";
    expected += "assertThat(StringHandling.fixFPNumberFormat(\"1.234.567,34\")).isNotEqualTo(\"123\\\",5\\\"67.34\");\n";
  ...
  public void Replace_Type_5() throws Exception {
    ...
    input += "assertArrayEquals(houses.getList(\" \\\",123 \", \"house_name\"), actual);\n";
    expected += "assertThat(actual).isEqualTo(houses.getList(\" \\\",123 \", \"house_name\"));\n";
  ...
  public void Replace_Type_6() throws Exception {
    ...
    input += "assertNull(calculate(abcd, \",\\\",123\\\",\", 1234));\n";
    expected += "assertThat(calculate(abcd, \",\\\",123\\\",\", 1234)).isNull();\n";
  ...
  public void Replace_Type_10() throws Exception {
    ...
    input += "assertSame(\"123\\\",5\\\"67.34\", StringHandling.fixFPNumberFormat(\"1.234\\.567\\,34\"));\n";
    expected += "assertThat(StringHandling.fixFPNumberFormat(\"1.234\\.567\\,34\")).isSameAs(\"123\\\",5\\\"67.34\");\n";
    tester.Start_Test(input, expected);

    input = "assertSame(\"123,567.34\", StringHandling.fixFPNumberFormat(\"1,234,567.34\"));\n";
    expected = "assertThat(StringHandling.fixFPNumberFormat(\"1,234,567.34\")).isSameAs(\"123,567.34\");\n";
