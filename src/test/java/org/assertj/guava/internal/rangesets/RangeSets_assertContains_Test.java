...
class RangeSets_assertContains_Test extends RangeSetsBaseTest {

  @Test
  void should_pass_if_actual_contains_value() {
    rangeSets.assertContains(someInfo(), actual, array(1, 15, 32));
    // Order does not matter
    rangeSets.assertContains(someInfo(), actual, array(15, 1, 32));
  }

  @Test
  void should_pass_if_actual_contains_duplicated_array_value() {
    rangeSets.assertContains(someInfo(), actual, array(1, 1, 15, 15, 32, 32));
  }

  @Test
  void should_throw_error_if_array_of_values_to_look_for_is_null() {
    assertThatIllegalArgumentException().isThrownBy(() -> rangeSets.assertContains(someInfo(), actual, null))
                                        .withMessage(valuesToLookForIsNull());
  }

  @Test
  void should_throw_error_if_actual_is_null() {
    assertThatExceptionOfType(AssertionError.class).isThrownBy(() -> rangeSets.assertContains(someInfo(),
                                                                                              null,
                                                                                              array()))
  ...
  void should_throw_error_if_array_of_values_to_look_for_is_empty() {
    assertThatIllegalArgumentException().isThrownBy(() -> rangeSets.assertContains(someInfo(), actual, array()))
  ...
  void should_pass_if_both_actual_and_expected_are_empty() {
    actual.clear();
    rangeSets.assertContains(someInfo(), actual, array());
  }
