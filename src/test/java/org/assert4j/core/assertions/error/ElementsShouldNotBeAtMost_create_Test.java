...
import org.assert4j.core.assertions.error.ElementsShouldNotBeAtMost;
...
public class ElementsShouldNotBeAtMost_create_Test {
  ...
  @Before
  public void setUp() {
    factory = elementsShouldNotBeAtMost(newArrayList("Yoda", "Luke", "Obiwan"), 2, new TestCondition<String>("not a Jedi"));
  }
