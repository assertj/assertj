...
import org.assert4j.core.assertions.error.ShouldNotBeBetween;
import org.junit.Test;


/**
 * Tests for <code>{@link ShouldNotBeBetween#create(Description)}</code>.
 * 
...
public class ShouldNotBeBetween_create_Test {
  ...
  public void should_create_error_message_with_period_boundaries_included() {
    ...
    assertEquals("[Test] expected:<2009-01-01T00:00:00> not to be in period [2011-01-01T00:00:00, 2012-01-01T00:00:00]", message);
  }
  ...
  public void should_create_error_message_with_period_lower_boundary_included() {
    ...
    String message = factory.create(new TextDescription("Test"));
    assertEquals("[Test] expected:<2012-01-01T00:00:00> not to be in period [2011-01-01T00:00:00, 2012-01-01T00:00:00[", message);
  }
  ...
  public void should_create_error_message_with_period_upper_boundary_included() {
    ...
    String message = factory.create(new TextDescription("Test"));
    assertEquals("[Test] expected:<2011-01-01T00:00:00> not to be in period ]2011-01-01T00:00:00, 2012-01-01T00:00:00]", message);
  }
