...
import static org.assert4j.core.assertions.error.ShouldBeInSameMillisecond.shouldBeInSameMillisecond;

import java.text.*;
import java.util.Date;

import org.assert4j.core.assertions.description.*;
import org.assert4j.core.assertions.error.ShouldBeInSameMillisecond;
