...
import org.assert4j.core.assertions.api.abstract_.AbstractAssert_isNull_Test;
 ...
 * a subpackage ({@link org.assert4j.core.assertions.api.bigdecimal}). The base class also serves as a proxy to the package-private fields
