...
import org.assert4j.core.assertions.core.DescriptionValidations;
import org.assert4j.core.assertions.description.*;
import org.assert4j.core.assertions.test.ExpectedException;
import org.junit.*;

/**
 * Tests for <code>{@link DescriptionValidations#checkIsNotNull(org.assert4j.core.assertions.description.Description)}</code> and
