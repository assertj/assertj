...
/**
 * Tests for
 * <code>{@link ObjectArrays#assertAreNotAtLeast(AssertionInfo, Object[], Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class ObjectArrays_assertAreNotAtLeast_Test extends AbstractTest_for_ObjectArrays {
