...
/**
 * Tests for
 * <code>{@link Iterables#assertDoNotHave(AssertionInfo, Iterable, org.fest.assertions.core.Condition)}</code>
 * .
 * 
 * @author Nicolas François
 */
public class Iterables_assertDoNotHave_Test extends AbstractTest_for_Iterables {
