...
public class DoubleArrays_assertEndsWith_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    arrays.assertEndsWith(info, null, array(8d));
  }
  ...
  private void assertThatFailureWasThrownWhenActualDoesNotEndWith(double[] sequence) {
  ...
  @Test public void should_pass_if_actual_ends_with_sequence() {
    arrays.assertEndsWith(info, actual, array(8d, 10d, 12d));
  }

  @Test public void should_pass_if_actual_and_sequence_are_equal() {
    arrays.assertEndsWith(info, actual, array(6d, 8d, 10d, 12d));
  }
}
