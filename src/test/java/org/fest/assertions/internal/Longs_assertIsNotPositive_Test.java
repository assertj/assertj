 ...
 */
public class Longs_assertIsNotPositive_Test extends AbstractTest_for_Longs {
  ...
  public void should_fail_since_actual_is_positive() {
    thrown.expectAssertionError("expected:<6L> to be less than or equal to:<0L>");
    longs.assertIsNotPositive(someInfo(), 6L);
  }

  @Test
  public void should_fail_since_actual_can_be_positive_according_to_custom_comparison_strategy() {
    thrown.expectAssertionError("expected:<-1L> to be less than or equal to:<0L> according to 'AbsValueComparator' comparator");
