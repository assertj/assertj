...
public class FloatArrays_assertContains_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    arrays.assertContains(info, null, array(8f));
  }
  ...
  @Test public void should_fail_if_actual_does_not_contain_values() {
    ...
    verify(failures).failure(info, doesNotContain(wrap(actual), wrap(expected), set(9f)));
  }
}
