 ...
 */
public class Collections_assertNotEmpty_Test extends AbstractTest_for_Collections {
  ...
  public void should_pass_if_actual_is_not_empty_whatever_custom_comparison_strategy_is() {
    collectionsWithCaseInsensitiveComparisonStrategy.assertNotEmpty(someInfo(), list("Luke"));
  }
  
  @Test
  public void should_fail_if_actual_is_null_whatever_custom_comparison_strategy_is() {
    thrown.expectAssertionError(actualIsNull());
    collectionsWithCaseInsensitiveComparisonStrategy.assertNotEmpty(someInfo(), null);
  }
  ...
  public void should_fail_if_actual_is_empty_whatever_custom_comparison_strategy_is() {
    AssertionInfo info = someInfo();
    try {
      collectionsWithCaseInsensitiveComparisonStrategy.assertNotEmpty(info, emptyList());
    } catch (AssertionError e) {
      verify(failures).failure(info, shouldNotBeEmpty());
      return;
    }
