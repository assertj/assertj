 ...
 */
public class Iterables_assertStartsWith_Test extends AbstractTest_for_Iterables {
  ...
  public void should_pass_if_actual_and_sequence_are_equal_according_to_custom_comparison_strategy() {
    iterablesWithCaseInsensitiveComparisonStrategy.assertStartsWith(someInfo(), actual,
