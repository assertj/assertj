...
public class ByteArrays_assertContains_at_Index_Test {
  ...
  @Test public void should_throw_error_if_Index_is_out_of_bounds() {
    ...
    arrays.assertContains(info, actual, (byte)8, atIndex(6));
  }
  ...
  @Test public void should_pass_if_actual_contains_value_at_index() {
    arrays.assertContains(info, actual, (byte)8, atIndex(1));
  }
}
