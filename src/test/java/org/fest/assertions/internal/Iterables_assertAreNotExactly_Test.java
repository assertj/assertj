...
/**
 * Tests for
 * <code>{@link Iterables#assertAreNotExactly(AssertionInfo, Iterable, Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class Iterables_assertAreNotExactly_Test extends AbstractTest_for_Iterables {
