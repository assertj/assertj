...
public class CharArrays_assertContains_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    arrays.assertContains(info, null, array('a'));
  }
