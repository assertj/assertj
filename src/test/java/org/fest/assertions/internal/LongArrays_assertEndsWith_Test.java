...
public class LongArrays_assertEndsWith_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    arrays.assertEndsWith(info, null, array(8L));
  }
  ...
  private void assertThatFailureWasThrownWhenActualDoesNotEndWith(long[] sequence) {
  ...
  @Test public void should_pass_if_actual_ends_with_sequence() {
    arrays.assertEndsWith(info, actual, array(8L, 10L, 12L));
  }

  @Test public void should_pass_if_actual_and_sequence_are_equal() {
    arrays.assertEndsWith(info, actual, array(6L, 8L, 10L, 12L));
  }
}
