 ...
 * @author Yvonne Wang
 */
public class Collections_assertNullOrEmpty_Test extends AbstractTest_for_Collections {
  ...
  public void should_pass_if_actual_is_null_whatever_custom_comparison_strategy_is() {
    collectionsWithCaseInsensitiveComparisonStrategy.assertNullOrEmpty(someInfo(), null);
  }

  @Test
  public void should_pass_if_actual_is_empty_whatever_custom_comparison_strategy_is() {
    collectionsWithCaseInsensitiveComparisonStrategy.assertNullOrEmpty(someInfo(), emptyList());
  }
  ...
  public void should_fail_if_actual_has_elements_whatever_custom_comparison_strategy_is() {
    ...
    Collection<String> actual = list("Yoda");
    try {
      collectionsWithCaseInsensitiveComparisonStrategy.assertNullOrEmpty(info, actual);
    } catch (AssertionError e) {
      verify(failures).failure(info, shouldBeNullOrEmpty(actual));
      return;
    }
