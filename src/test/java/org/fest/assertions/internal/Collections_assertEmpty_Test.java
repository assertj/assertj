 ...
 */
public class Collections_assertEmpty_Test extends AbstractTest_for_Collections {
  ...
  public void should_pass_if_actual_is_empty_whatever_custom_comparison_strategy_is() {
    collectionsWithCaseInsensitiveComparisonStrategy.assertEmpty(someInfo(), emptyList());
  }
  
  @Test
  public void should_fail_if_actual_is_null_whatever_custom_comparison_strategy_is() {
    thrown.expectAssertionError(actualIsNull());
    collectionsWithCaseInsensitiveComparisonStrategy.assertEmpty(someInfo(), null);
  }
  ...
  public void should_fail_if_actual_has_elements_whatever_custom_comparison_strategy_is() {
    ...
    Collection<String> actual = list("Yoda");
    try {
      collectionsWithCaseInsensitiveComparisonStrategy.assertEmpty(info, actual);
    } catch (AssertionError e) {
      verify(failures).failure(info, shouldBeEmpty(actual));
      return;
    }
