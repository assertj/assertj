...
/**
 * Tests for
 * <code>{@link ObjectArrays#assertDoNotHaveAtLeast(AssertionInfo, Object[], Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 */
public class ObjectArrays_assertDoNotHaveAtLeast_Test extends AbstractTest_for_ObjectArrays {
