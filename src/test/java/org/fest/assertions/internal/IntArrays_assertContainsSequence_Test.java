...
public class IntArrays_assertContainsSequence_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    arrays.assertContainsSequence(info, null, arrayOfInts(8));
  }
  ...
  @Test public void should_pass_if_actual_contains_sequence() {
    arrays.assertContainsSequence(info, actual, arrayOfInts(6, 8));
  }

  @Test public void should_pass_if_actual_and_sequence_are_equal() {
    arrays.assertContainsSequence(info, actual, arrayOfInts(6, 8, 10, 12));
  }
}
