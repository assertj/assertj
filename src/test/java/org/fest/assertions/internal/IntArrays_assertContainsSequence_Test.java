...
public class IntArrays_assertContainsSequence_Test {
  ...
  @BeforeClass public static void setUpOnce() {
    ...
    actual = ArrayFactory.arrayOfInts(6, 8, 10, 12);
  }
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    arrays.assertContainsSequence(info, null, ArrayFactory.arrayOfInts(8));
  }
  ...
  @Test public void should_throw_error_if_sequence_is_empty() {
    ...
    arrays.assertContainsSequence(info, actual, new int[0]);
  }
  ...
  private void assertThatFailureWasThrownWhenSequenceWasNotFound(int[] sequence) {
  ...
  @Test public void should_pass_if_actual_contains_sequence() {
    arrays.assertContainsSequence(info, actual, ArrayFactory.arrayOfInts(6, 8));
  }

  @Test public void should_pass_if_actual_and_sequence_are_equal() {
    arrays.assertContainsSequence(info, actual, ArrayFactory.arrayOfInts(6, 8, 10, 12));
  }
}
