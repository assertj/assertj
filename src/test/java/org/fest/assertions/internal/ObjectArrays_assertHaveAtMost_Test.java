...
/**
 * Tests for
 * <code>{@link ObjectArrays#assertHaveAtMost(AssertionInfo, Object[], Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class ObjectArrays_assertHaveAtMost_Test extends AbstractTest_for_ObjectArrays {
