...
/**
 * Tests for
 * <code>{@link Iterables#assertAreAtMost(AssertionInfo, Iterable, Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class Iterables_assertAreAtMost_Test extends AbstractTest_for_Iterables {
