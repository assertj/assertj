...
/**
 * Tests for
 * <code>{@link Iterables#assertDoNotHaveAtMost(AssertionInfo, Iterable, Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class Iterables_assertDoNotHaveAtMost_Test extends AbstractTest_for_Iterables {
