...
public class Doubles_assertGreaterThanOrEqualTo_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    doubles.assertGreaterThanOrEqualTo(info, null, 8d);
  }

  @Test public void should_pass_if_actual_is_greater_than_other() {
    doubles.assertGreaterThanOrEqualTo(info, 8d, 6d);
  }

  @Test public void should_pass_if_actual_is_equal_to_other() {
    doubles.assertGreaterThanOrEqualTo(info, 6d, 6d);
  }
  ...
  @Test public void should_fail_if_actual_is_less_than_other() {
    ...
    verify(failures).failure(info, isNotGreaterThanOrEqualTo(6d, 8d));
  }
}
