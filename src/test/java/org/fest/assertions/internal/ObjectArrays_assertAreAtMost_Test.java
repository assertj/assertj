...
/**
 * Tests for
 * <code>{@link ObjectArrays#assertAreAtMost(AssertionInfo, Object[], Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 */
public class ObjectArrays_assertAreAtMost_Test extends AbstractTest_for_ObjectArrays {
