...
public class Conditions_assertSatisfies_Test {
  ...
  @Test public void should_throw_error_if_Condition_is_null() {
    thrown.expectNullPointerException("The condition to verify should not be null");
  ...
  @Test public void should_fail_if_Condition_is_not_met() {
    ...
    when(failures.failure(info, errorWhenConditionNotMet(actual, condition))).thenReturn(expectedError);
