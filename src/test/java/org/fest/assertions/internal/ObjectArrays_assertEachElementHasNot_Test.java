...
/**
 * Tests for
 * <code>{@link ObjectArrays#assertEachElementHasNot(org.fest.assertions.core.AssertionInfo, Object[], org.fest.assertions.core.Condition)}</code>
 * .
 * 
 * @author Nicolas François
 */
public class ObjectArrays_assertEachElementHasNot_Test extends AbstractTest_for_ObjectArrays {
	...
	public void should_pass_if_each_element_satisfies_condition() {
		...
		arrays.assertEachElementHasNot(someInfo(), actual, condition);
	}	
	
	@Test
	public void should_throw_error_if_condition_is_null() {
		thrown.expectNullPointerException("The condition to evaluate should not be null");
		arrays.assertEachElementHasNot(someInfo(), actual, null);
	}
	...
	public void should_fail_if_condition_is_met() {
	    ...
	    try {
	      ...
	      verify(failures).failure(info, eachElementShouldNotHave(actual, list("Yoda"), condition));
	      return;
	    }
	    failBecauseExpectedAssertionErrorWasNotThrown();
	}	
