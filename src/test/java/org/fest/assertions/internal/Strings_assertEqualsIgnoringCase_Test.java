 ...
 */
public class Strings_assertEqualsIgnoringCase_Test extends AbstractTest_for_Strings {
  ...
  public void should_pass_if_both_Strings_are_equal_but_not_same_whatever_custom_comparison_strategy_is() {
    stringsWithCaseInsensitiveComparisonStrategy.assertEqualsIgnoringCase(someInfo(), "Yoda", new String(array('Y', 'o', 'd', 'a')));
  }
