...
public class CharArrays_assertStartsWith_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    arrays.assertStartsWith(info, null, ArrayFactory.arrayOfChars('a'));
  }
  ...
  @Test public void should_pass_if_actual_starts_with_sequence() {
    arrays.assertStartsWith(info, actual, ArrayFactory.arrayOfChars('a', 'b', 'c'));
  }

  @Test public void should_pass_if_actual_and_sequence_are_equal() {
    arrays.assertStartsWith(info, actual, ArrayFactory.arrayOfChars('a', 'b', 'c', 'd'));
  }
}
