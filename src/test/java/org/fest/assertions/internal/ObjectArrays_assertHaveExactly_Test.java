...
/**
 * Tests for
 * <code>{@link ObjectArrays#assertHaveExactly(AssertionInfo, Object[], Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 */
public class ObjectArrays_assertHaveExactly_Test extends AbstractTest_for_ObjectArrays {
