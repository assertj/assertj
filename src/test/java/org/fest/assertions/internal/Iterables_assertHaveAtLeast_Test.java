...
/**
 * Tests for
 * <code>{@link Iterables#assertHaveAtLeast(AssertionInfo, Iterable, Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class Iterables_assertHaveAtLeast_Test extends AbstractTest_for_Iterables {
