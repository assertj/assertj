 ...
 */
public class ObjectArrays_assertDoesNotContain_at_Index_Test extends AbstractTest_for_ObjectArrays {
  ...
  public void should_fail_if_actual_contains_value_at_index_according_to_custom_comparison_strategy() {
    ...
    try {
      ...
      verify(failures).failure(info,
          shouldNotContainAtIndex(actual, "YOda", index, caseInsensitiveStringComparisonStrategy));
      return;
    }
    failBecauseExpectedAssertionErrorWasNotThrown();
  }
