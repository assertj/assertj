...
/**
 * Tests for
 * <code>{@link Iterables#assertAreAtLeast(AssertionInfo, Iterable, Condition, int)}</code>
 * .
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class Iterables_assertAreAtLeast_Test extends AbstractTest_for_Iterables {
