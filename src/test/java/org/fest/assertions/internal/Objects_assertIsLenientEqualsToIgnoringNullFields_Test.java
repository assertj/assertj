 ...
 */
public class Objects_assertIsLenientEqualsToIgnoringNullFields_Test {
  ...
  @Test public void should_pass_when_same_fields_with_null_in_actual() {
	 Jedi actual = new Jedi("Yoda", "Green");
	 Jedi other = new Jedi("Yoda", null);
	 objects.assertIsLenientEqualsToByIgnoringNullFields(someInfo(), actual, other);	 
  }
  
  @Test public void should_fail_when_same_fields_with_null_in_actual() {
