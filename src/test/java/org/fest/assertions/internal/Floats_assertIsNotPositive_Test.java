 ...
 */
public class Floats_assertIsNotPositive_Test extends AbstractTest_for_Floats {
  ...
  public void should_fail_since_actual_can_be_positive_according_to_custom_comparison_strategy() {
    thrown.expectAssertionError("expected:<-1.0f> to be less than or equal to:<0.0f> according to 'AbsValueComparator' comparator");
