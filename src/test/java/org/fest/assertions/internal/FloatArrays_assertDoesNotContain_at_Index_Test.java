...
public class FloatArrays_assertDoesNotContain_at_Index_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    arrays.assertDoesNotContain(someInfo(), null, 8f, atIndex(0));
  }

  @Test public void should_pass_if_actual_is_empty() {
    arrays.assertDoesNotContain(someInfo(), emptyArray(), 8f, atIndex(0));
  }
  ...
  @Test public void should_fail_if_actual_contains_value_at_index() {
    ...
    verify(failures).failure(info, containsAtIndex(wrap(actual), 6f, index));
  }
}
