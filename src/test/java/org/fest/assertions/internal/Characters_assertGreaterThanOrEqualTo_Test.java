 ...
 * @author Alex Ruiz
 */
public class Characters_assertGreaterThanOrEqualTo_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    characters.assertGreaterThanOrEqualTo(info, null, 'a');
  }
  ...
  @Test public void should_pass_if_actual_is_equal_to_other() {
    characters.assertGreaterThanOrEqualTo(info, 'b', 'b');
  }
