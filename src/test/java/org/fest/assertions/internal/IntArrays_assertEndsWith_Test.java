...
public class IntArrays_assertEndsWith_Test {
  ...
  @Test public void should_fail_if_actual_is_null() {
    ...
    arrays.assertEndsWith(info, null, ArrayFactory.arrayOfInts(8));
  }
  ...
  @Test public void should_pass_if_actual_ends_with_sequence() {
    arrays.assertEndsWith(info, actual, ArrayFactory.arrayOfInts(8, 10, 12));
  }

  @Test public void should_pass_if_actual_and_sequence_are_equal() {
    arrays.assertEndsWith(info, actual, ArrayFactory.arrayOfInts(6, 8, 10, 12));
  }
}
