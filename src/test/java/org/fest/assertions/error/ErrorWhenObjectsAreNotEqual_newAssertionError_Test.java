 ...
 * @author Alex Ruiz
 */
public class ErrorWhenObjectsAreNotEqual_newAssertionError_Test {

  private Description description;
  private Formatter formatter;
  private ErrorWhenObjectsAreNotEqual factory;

  @Before public void setUp() {
    description = new TestDescription("Jedi");
    formatter = mock(Formatter.class);
    factory = new ErrorWhenObjectsAreNotEqual("Luke", "Yoda");
