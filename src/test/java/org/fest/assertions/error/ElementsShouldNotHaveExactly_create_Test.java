...
public class ElementsShouldNotHaveExactly_create_Test {
	  ...
	  @Before public void setUp() {
	    factory = elementsShouldNotHaveAtLeast(list("Yoda","Solo", "Leia"), 2, new TestCondition<String>("Jedi power"));
	  }

	  @Test 
	  public void should_create_error_message() {
	    String message = factory.create(new TextDescription("Test"));
	    assertEquals("[Test] expecting: elements  <['Yoda', 'Solo', 'Leia']> not to have at least 2 times <Jedi power>", message);
	  }		
