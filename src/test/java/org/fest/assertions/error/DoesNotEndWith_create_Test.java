...
/**
 * Tests for <code>{@link DoesNotEndWith#create(Description)}</code>.
 *
 * @author Alex Ruiz
 */
public class DoesNotEndWith_create_Test {

  private ErrorMessage errorMessage;

  @Before public void setUp() {
    errorMessage = doesNotEndWith(list("Yoda", "Luke"), list("Han", "Leia"));
  }
