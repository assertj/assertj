...
/**
 * Tests for <code>{@link NotLessThan#create(Description)}</code>.
 *
 * @author Alex Ruiz
 */
public class NotLessThan_create_Test {

  private NotLessThan errorMessage;

  @Before public void setUp() {
    errorMessage = notLessThan(8, 6);
  }
