...
import static org.fest.assertions.error.ErrorWhenObjectsAreNotEqual.MSG_ARG_TYPES;
...
/**
 * Tests for <code>{@link ErrorWhenObjectsAreNotEqual#newAssertionError(Description)}</code>.
 *
 * @author Alex Ruiz
 */
public class ErrorWhenObjectsAreNotEqual_newAssertionError_without_JUnit_Test {

  private Description description;
  private ErrorWhenObjectsAreNotEqual errorFactory;
  private ConstructorInvoker invoker;

  @Before public void setUp() {
    description = new TestDescription("Jedi");
    errorFactory = new ErrorWhenObjectsAreNotEqual("Luke", "Yoda");
