 ...
 */
public class IterableAssert_startsWith_Test extends AbstractTest_for_IterableAssert {

  @Test
  public void should_verify_that_actual_starts_with_sequence() {
    assertions.startsWith("Luke", "Yoda");
    verify(iterables).assertStartsWith(assertions.info, assertions.actual, array("Luke", "Yoda"));
  }
