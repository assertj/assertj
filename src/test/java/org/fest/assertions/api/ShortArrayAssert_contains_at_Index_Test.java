...
public class ShortArrayAssert_contains_at_Index_Test {
  ...
  @Test
  public void should_verify_that_actual_contains_value_at_index() {
    Index index = someIndex();
    assertions.contains((short) 8, index);
    verify(arrays).assertContains(assertions.info, assertions.actual, (short) 8, index);
  }

  @Test
  public void should_return_this() {
    ShortArrayAssert returned = assertions.contains((short) 8, someIndex());
