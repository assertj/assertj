...
/**
 * Tests for <code>{@link GenericAssert#as(Description)}</code>
 *
 * @author Alex Ruiz
 */
public class GenericAssert_as_with_description_Test {
  ...
  @Test public void should_return_this() {
    ConcreteGenericAssert descriptable = assertions.as(d);
