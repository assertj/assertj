 ...
 * @author Alex Ruiz
 */
public class ShortAssert_isLessThanOrEqualTo_short_Test extends ShortAssertTest {
  ...
  protected void verify_internal_object_was_invoked() {
    verify(shorts).assertLessThanOrEqualTo(assertionsInfo(), assertionsActual(), (short) 8);
  }
}
