...
public class ShortArrayAssert_contains_Test {
  ...
  @Test public void should_verify_that_actual_contains_given_values() {
    assertions.contains((short)6, (short)8);
    verify(arrays).assertContains(assertions.info, assertions.actual, array(6, 8));
  }

  @Test public void should_return_this() {
    ShortArrayAssert returned = assertions.contains((short)8);
