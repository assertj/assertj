...
public class FloatAssert_isEqualTo_float_with_offset_Test {
  ...
  public void should_verify_that_actual_is_equal_to_expected() {
    assertions.isEqualTo(8f, offset);
    verify(floats).assertEqual(assertions.info, assertions.actual, 8f, offset);
  }

  @Test
  public void should_return_this() {
    FloatAssert returned = assertions.isEqualTo(8f, offset);
