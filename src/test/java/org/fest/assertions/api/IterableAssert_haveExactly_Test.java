 ...
 */
public class IterableAssert_haveExactly_Test extends AbstractTest_for_IterableAssert {
	  ...
	  public void should_verify_that_elements_have_at_most() {
	    ...
	    verify(iterables).assertHaveExactly(assertions.info, assertions.actual, 2, condition);
	  }
