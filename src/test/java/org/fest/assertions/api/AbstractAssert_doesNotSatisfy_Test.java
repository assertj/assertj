...
/**
 * Tests for <code>{@link AbstractAssert#doesNotSatisfy(Condition)}</code>.
 *
 * @author Alex Ruiz
 */
public class AbstractAssert_doesNotSatisfy_Test {
  ...
  @Test public void should_return_this() {
    ConcreteAssert returned = assertions.doesNotSatisfy(condition);
