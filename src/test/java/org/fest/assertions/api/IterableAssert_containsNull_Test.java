 ...
 */
public class IterableAssert_containsNull_Test extends AbstractTest_for_IterableAssert {

  @Test
  public void should_verify_that_actual_contains_null() {
    assertions.containsNull();
    verify(iterables).assertContainsNull(assertions.info, assertions.actual);
  }
