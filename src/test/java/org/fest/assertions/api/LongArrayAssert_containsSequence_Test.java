...
public class LongArrayAssert_containsSequence_Test {
  ...
  @Test public void should_verify_that_actual_contains_sequence() {
    assertions.containsSequence(6L, 8L);
    verify(arrays).assertContainsSequence(assertions.info, assertions.actual, array(6L, 8L));
  }

  @Test public void should_return_this() {
    LongArrayAssert returned = assertions.containsSequence(8L);
