...
/**
 * Tests for <code>{@link IntegerAssert#satisfies(Condition)}</code>.
 *
 * @author Alex Ruiz
 */
public class IntegerAssert_satisfies_Test {
  ...
  @Test public void should_return_this() {
    IntegerAssert returned = assertions.satisfies(condition);
