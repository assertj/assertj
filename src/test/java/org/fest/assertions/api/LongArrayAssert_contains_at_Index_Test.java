...
public class LongArrayAssert_contains_at_Index_Test {
  ...
  public void should_verify_that_actual_contains_value_at_index() {
    ...
    assertions.contains(8L, index);
    verify(arrays).assertContains(assertions.info, assertions.actual, 8L, index);
  }

  @Test
  public void should_return_this() {
    LongArrayAssert returned = assertions.contains(8L, someIndex());
