...
public class LongArrayAssert_contains_at_Index_Test {
  ...
  @Test public void should_verify_that_actual_contains_value_at_index() {
    assertions.contains(8L, atIndex(2));
    verify(arrays).assertContains(assertions.info, assertions.actual, 8L, atIndex(2));
  }

  @Test public void should_return_this() {
    LongArrayAssert returned = assertions.contains(8L, atIndex(6));
