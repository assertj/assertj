...
public class DoubleAssert_isLessThanOrEqualTo_double_Test {
  ...
  @Test public void should_verify_that_actual_is_less_than_expected() {
    assertions.isLessThanOrEqualTo(8d);
    verify(doubles).assertLessThanOrEqualTo(assertions.info, assertions.actual, 8d);
  }

  @Test public void should_return_this() {
    DoubleAssert returned = assertions.isLessThanOrEqualTo(8d);
