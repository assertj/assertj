 ...
 */
public class IterableAssert_doesNotContainNull_Test extends AbstractTest_for_IterableAssert {

  @Test
  public void should_verify_that_actual_does_not_contain_null() {
    assertions.doesNotContainNull();
    verify(iterables).assertDoesNotContainNull(assertions.info, assertions.actual);
  }
