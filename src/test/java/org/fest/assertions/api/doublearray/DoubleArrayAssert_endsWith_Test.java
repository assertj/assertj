 ...
 * @author Alex Ruiz
 */
public class DoubleArrayAssert_endsWith_Test extends DoubleArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertEndsWith(getInfo(assertions), getActual(assertions), array(6d, 8d));
  }
}
