 ...
 * @author Alex Ruiz
 */
public class DoubleArrayAssert_startsWith_Test extends DoubleArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertStartsWith(getInfo(assertions), getActual(assertions), array(6d, 8d));
  }
}
