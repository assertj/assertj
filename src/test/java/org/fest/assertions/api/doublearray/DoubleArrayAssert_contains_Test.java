 ...
 * @author Alex Ruiz
 */
public class DoubleArrayAssert_contains_Test extends DoubleArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContains(getInfo(assertions), getActual(assertions), array(6d, 8d));
  }
}
