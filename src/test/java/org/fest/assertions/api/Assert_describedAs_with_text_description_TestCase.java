...
/**
 * Test case for implementations of <code>{@link Assert#describedAs(String)}</code>.
 *
 * @author Alex Ruiz
 */
public abstract class Assert_describedAs_with_text_description_TestCase {
  ...
  @Test public final void should_set_description() {
    ...
    assertSame(description, descriptionOf(assertions));
  }
