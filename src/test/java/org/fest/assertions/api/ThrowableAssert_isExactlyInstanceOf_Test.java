...
public class ThrowableAssert_isExactlyInstanceOf_Test {
  ...
  @Test public void should_verify_that_actual_contains_sequence() {
    assertions.isExactlyInstanceOf(NullPointerException.class);
    verify(throwables).assertIsExactlyInstanceOf(assertions.info, assertions.actual, NullPointerException.class);
  }

  @Test public void should_return_this() {
    ThrowableAssert returned = assertions.isExactlyInstanceOf(NullPointerException.class);
