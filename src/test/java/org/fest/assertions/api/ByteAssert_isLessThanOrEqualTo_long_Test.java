...
public class ByteAssert_isLessThanOrEqualTo_long_Test {
  ...
  @Test public void should_verify_that_actual_is_less_than_expected() {
    assertions.isLessThanOrEqualTo((byte)8);
    verify(bytes).assertLessThanOrEqualTo(assertions.info, assertions.actual, (byte)8);
  }

  @Test public void should_return_this() {
    ByteAssert returned = assertions.isLessThanOrEqualTo((byte)8);
