...
public class LongArrayAssert_containsOnly_Test {
  ...
  @Test public void should_verify_that_actual_contains_given_values_only() {
    assertions.containsOnly(6L, 8L);
    verify(arrays).assertContainsOnly(assertions.info, assertions.actual, array(6L, 8L));
  }

  @Test public void should_return_this() {
    LongArrayAssert returned = assertions.containsOnly(8L);
