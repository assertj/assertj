...
/**
 * Tests for <code>{@link IntegerAssert#doesNotSatisfy(Condition)}</code>.
 *
 * @author Alex Ruiz
 */
public class IntegerAssert_doesNotSatisfy_Test {
  ...
  @Test public void should_return_this() {
    IntegerAssert returned = assertions.doesNotSatisfy(condition);
