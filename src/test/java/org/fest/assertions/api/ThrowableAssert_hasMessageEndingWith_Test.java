...
public class ThrowableAssert_hasMessageEndingWith_Test {
  ...
  @Test public void should_verify_that_actual_contains_sequence() {
    assertions.hasMessageEndingWith("age");
    verify(throwables).assertHasMessageEndingWith(assertions.info, assertions.actual, "age");
  }

  @Test public void should_return_this() {
    ThrowableAssert returned = assertions.hasMessageEndingWith("whatever");
