...
/**
 * Tests for <code>{@link GenericCollectionAssert#startsWith(Object...)}</code>.
 *
 * @author Alex Ruiz
 */
public class GenericCollectionAssert_startsWith_Test {
  ...
  @Test public void should_return_this() {
    ConcreteGenericCollectionAssert returned = assertions.startsWith("Luke", "Yoda");
