...
public class ThrowableAssert_hasMessageContaining_Test {
  ...
  public void should_verify_that_actual_contains_sequence() {
    assertions.hasMessageContaining("able");
    verify(throwables).assertHasMessageContaining(assertions.info, assertions.actual, "able");
  }

  @Test
  public void should_return_this() {
    ThrowableAssert returned = assertions.hasMessageContaining("whatever");
