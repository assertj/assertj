...
public class AbstractAssert_has_Test {
  ...
  @Test
  public void should_verify_that_actual_satisfies_Condition() {
    assertions.has(condition);
    verify(conditions).assertHas(assertions.info, assertions.actual, condition);
  }

  @Test
  public void should_return_this() {
    ConcreteAssert returned = assertions.has(condition);
