...
public class CharacterAssert_isLessThanOrEqualTo_char_Test {
  ...
  @Test public void should_verify_that_actual_is_less_than_expected() {
    assertions.isLessThanOrEqualTo('b');
    verify(characters).assertLessThanOrEqualTo(assertions.info, assertions.actual, 'b');
  }

  @Test public void should_return_this() {
    CharacterAssert returned = assertions.isLessThanOrEqualTo('b');
