...
public class ThrowableAssert_hasMessageStartingWith_Test {
  ...
  public void should_verify_that_actual_contains_sequence() {
    assertions.hasMessageStartingWith("throw");
    verify(throwables).assertHasMessageStartingWith(assertions.info, assertions.actual, "throw");
  }

  @Test
  public void should_return_this() {
    ThrowableAssert returned = assertions.hasMessageStartingWith("whatever");
