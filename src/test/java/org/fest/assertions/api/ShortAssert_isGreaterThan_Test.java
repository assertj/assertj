 ...
 * @author Alex Ruiz
 */
public class ShortAssert_isGreaterThan_Test {
  ...
  @Test public void should_verify_that_actual_is_greater_than_expected() {
    assertions.isGreaterThan(new Short((short)6));
    verify(comparables).assertGreaterThan(assertions.info, assertions.actual, (short)6);
  }

  @Test public void should_return_this() {
    ShortAssert returned = assertions.isGreaterThan(new Short((short)6));
