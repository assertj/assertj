 ...
 * @author Alex Ruiz
 */
public class FloatArrayAssert_contains_Test extends FloatArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContains(getInfo(assertions), getActual(assertions), array(6f, 8f));
  }
}
