 ...
 * @author Alex Ruiz
 */
public class FloatArrayAssert_doesNotContain_Test extends FloatArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoesNotContain(getInfo(assertions), getActual(assertions), array(6f, 8f));
  }
}
