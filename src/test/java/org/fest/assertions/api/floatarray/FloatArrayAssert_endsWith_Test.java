 ...
 * @author Alex Ruiz
 */
public class FloatArrayAssert_endsWith_Test extends FloatArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertEndsWith(getInfo(assertions), getActual(assertions), array(6f, 8f));
  }
}
