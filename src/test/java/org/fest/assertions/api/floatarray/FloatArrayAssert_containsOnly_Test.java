 ...
 * @author Alex Ruiz
 */
public class FloatArrayAssert_containsOnly_Test extends FloatArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsOnly(getInfo(assertions), getActual(assertions), array(6f, 8f));
  }
}
