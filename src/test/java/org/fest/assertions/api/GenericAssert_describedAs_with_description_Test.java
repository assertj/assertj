...
/**
 * Tests for <code>{@link GenericAssert#describedAs(Description)}</code>
 *
 * @author Alex Ruiz
 */
public class GenericAssert_describedAs_with_description_Test {
  ...
  @Test public void should_return_this() {
    ConcreteGenericAssert descriptable = assertions.describedAs(d);
