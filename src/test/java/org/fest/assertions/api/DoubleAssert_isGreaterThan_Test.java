 ...
 * @author Alex Ruiz
 */
public class DoubleAssert_isGreaterThan_Test {
  ...
  @Test public void should_verify_that_actual_is_greater_than_expected() {
    assertions.isGreaterThan(new Double(6));
    verify(comparables).assertGreaterThan(assertions.info, assertions.actual, 6d);
  }

  @Test public void should_return_this() {
    DoubleAssert returned = assertions.isGreaterThan(new Double(6));
