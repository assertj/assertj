 ...
 * @author Alex Ruiz
 */
public class ShortArrayAssert_containsOnly_Test extends ShortArrayAssertTest {
  ...
  protected void verify_internal_object_was_invoked() {
    verify(arrays).assertContainsOnly(assertionsInfo(), assertionsActual(), array(6, 8));
  }
}
