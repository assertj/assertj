 ...
 * @author Alex Ruiz
 */
public class ShortArrayAssert_doesNotContain_Test extends ShortArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoesNotContain(getInfo(assertions), getActual(assertions), array(6, 8));
  }
}
