 ...
 * @author Alex Ruiz
 */
public class ShortArrayAssert_endsWith_Test extends ShortArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertEndsWith(getInfo(assertions), getActual(assertions), array(6, 8));
  }
}
