...
public class ByteArrayAssert_doesNotContain_at_Index_Test {
  ...
  @Test public void should_verify_that_actual_does_not_contain_value_at_index() {
    assertions.doesNotContain((byte)8, atIndex(2));
    verify(arrays).assertDoesNotContain(assertions.info, assertions.actual, (byte)8, atIndex(2));
  }

  @Test public void should_return_this() {
    ByteArrayAssert returned = assertions.doesNotContain((byte)8, atIndex(6));
