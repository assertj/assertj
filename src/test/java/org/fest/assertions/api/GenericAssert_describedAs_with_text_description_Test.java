...
/**
 * Tests for <code>{@link GenericAssert#describedAs(String)}</code>.
 *
 * @author Alex Ruiz
 */
public class GenericAssert_describedAs_with_text_description_Test {
  ...
  @Test public void should_return_this() {
    ConcreteGenericAssert descriptable = assertions.describedAs(description);
