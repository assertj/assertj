...
public class ObjectArrayAssert_areNotExactly_Test {
	  ...
	  @Test public void should_verify_that_elements_are_at_most() {
	    assertions.areNotExactly(2, condition);
	    verify(arrays).assertAreNotExactly(assertions.info, assertions.actual, 2, condition);
	  }

	  @Test public void should_return_this() {
	    assertSame(assertions, assertions.areNotExactly(2, condition));
	  }	
