...
public class DoubleAssert_isEqualTo_with_offset_Test {
  ...
  public void should_verify_that_actual_is_equal_to_expected() {
    Double expected = new Double(8d);
    assertions.isEqualTo(expected, offset);
    verify(doubles).assertEqual(assertions.info, assertions.actual, expected, offset);
  }

  @Test
  public void should_return_this() {
    DoubleAssert returned = assertions.isEqualTo(new Double(8d), offset);
