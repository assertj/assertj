 ...
 * @author Alex Ruiz
 */
public class ByteAssert_isGreaterThan_Test {
  ...
  @Test public void should_verify_that_actual_is_greater_than_expected() {
    assertions.isGreaterThan(new Byte((byte)6));
    verify(comparables).assertGreaterThan(assertions.info, assertions.actual, (byte)6);
  }

  @Test public void should_return_this() {
    ByteAssert returned = assertions.isGreaterThan(new Byte((byte)6));
