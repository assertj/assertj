...
public class BooleanArrayAssert_containsOnly_Test {
  ...
  @Test public void should_verify_that_actual_contains_given_values_only() {
    ...
    verify(arrays).assertContainsOnly(assertions.info, assertions.actual, ArrayFactory.arrayOfBooleans(true, false));
  }

  @Test public void should_return_this() {
    BooleanArrayAssert returned = assertions.containsOnly(true);
