 ...
 * @author Alex Ruiz
 */
public class CharArrayAssert_containsOnly_Test extends CharArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsOnly(getInfo(assertions), getActual(assertions), array('a', 'b'));
  }
}
