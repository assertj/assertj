 ...
 */
public class AbstractAssert_isNotOfAnyClassIn_Test extends AbstractAssertTest {
  ...
  protected void verify_internal_class_was_invoked() {
    verify(objects).assertIsNotOfAnyClassIn(assertionsInfo(), assertionsActual(), new Class[] { Long.class, File.class });
  }
}
