 ...
 */
public class AbstractAssert_isNotInstanceOfAny_Test extends AbstractAssertTest {
  ...
  protected void verify_internal_class_was_invoked() {
    verify(objects).assertIsNotInstanceOfAny(assertionsInfo(), assertionsActual(), types);
  }
}
