...
public class DoubleArrayAssert_containsSequence_Test {
  ...
  @Test public void should_verify_that_actual_contains_sequence() {
    assertions.containsSequence(6d, 8d);
    verify(arrays).assertContainsSequence(assertions.info, assertions.actual, array(6d, 8d));
  }

  @Test public void should_return_this() {
    DoubleArrayAssert returned = assertions.containsSequence(8d);
