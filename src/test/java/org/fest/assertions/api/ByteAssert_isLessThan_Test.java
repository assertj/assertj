 ...
 * @author Alex Ruiz
 */
public class ByteAssert_isLessThan_Test {
  ...
  @Test public void should_verify_that_actual_is_less_than_expected() {
    assertions.isLessThan(new Byte((byte)8));
    verify(comparables).assertLessThan(assertions.info, assertions.actual, (byte)8);
  }

  @Test public void should_return_this() {
    ByteAssert returned = assertions.isLessThan(new Byte((byte)8));
