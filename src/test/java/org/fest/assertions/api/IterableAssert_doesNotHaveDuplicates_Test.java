 ...
 */
public class IterableAssert_doesNotHaveDuplicates_Test extends AbstractTest_for_IterableAssert {

  @Test
  public void should_verify_that_actual_does_not_have_duplicates() {
    assertions.doesNotHaveDuplicates();
    verify(iterables).assertDoesNotHaveDuplicates(assertions.info, assertions.actual);
  }
