 ...
 * @author Alex Ruiz
 */
public class BooleanArrayAssert_containsSequence_Test extends BooleanArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsSequence(getInfo(assertions), getActual(assertions), array(true, false));
  }
}
