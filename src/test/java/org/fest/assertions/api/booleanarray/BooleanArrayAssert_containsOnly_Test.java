 ...
 * @author Alex Ruiz
 */
public class BooleanArrayAssert_containsOnly_Test extends BooleanArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsOnly(getInfo(assertions), getActual(assertions), array(true, false));
  }
}
