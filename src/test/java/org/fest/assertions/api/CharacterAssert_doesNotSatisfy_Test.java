...
/**
 * Tests for <code>{@link CharacterAssert#doesNotSatisfy(Condition)}</code>.
 *
 * @author Alex Ruiz
 */
public class CharacterAssert_doesNotSatisfy_Test {
  ...
  @Test public void should_return_this() {
    CharacterAssert returned = assertions.doesNotSatisfy(condition);
