...
public class ObjectArrayAssert_doNotHaveExactly_Test {
	  ...
	  @Test public void should_verify_that_elements_not_have_at_most() {
	    assertions.doNotHaveExactly(2, condition);
	    verify(arrays).assertDoNotHaveExactly(assertions.info, assertions.actual, 2, condition);
	  }

	  @Test public void should_return_this() {
	    assertSame(assertions, assertions.doNotHaveExactly(2, condition));
	  }	
