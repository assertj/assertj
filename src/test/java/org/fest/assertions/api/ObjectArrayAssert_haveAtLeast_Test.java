...
public class ObjectArrayAssert_haveAtLeast_Test {
	  ...
	  @Test public void should_verify_that_elements_have_at_least() {
	    assertions.haveAtLeast(2, condition);
	    verify(arrays).assertHaveAtLeast(assertions.info, assertions.actual, 2, condition);
	  }

	  @Test public void should_return_this() {
	    assertSame(assertions, assertions.haveAtLeast(2, condition));
	  }	
