...
public class ObjectArrayAssert_doNotHaveAtLeast_Test {
	  ...
	  @Test public void should_verify_that_elements_not_have_at_least() {
	    assertions.doNotHaveAtLeast(2, condition);
	    verify(arrays).assertDoNotHaveAtLeast(assertions.info, assertions.actual, 2, condition);
	  }

	  @Test public void should_return_this() {
	    assertSame(assertions, assertions.doNotHaveAtLeast(2, condition));
	  }	
