...
/**
 * Tests for <code>{@link ListAssert#containsExclusively(Object...)}</code>.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class ListAssert_containsExclusively_Test {
  ...
  @Test public void should_return_this() {
    ListAssert returned = assertions.containsExclusively("Luke");
