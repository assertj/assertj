 ...
 * @author Alex Ruiz
 */
public class DoubleAssert_doesNotSatisfy_Test {

  private static Condition<Double> condition;

  private Conditions conditions;
  private DoubleAssert assertions;

  @BeforeClass public static void setUpOnce() {
    condition = new TestCondition<Double>();
  }
  ...
  @Test public void should_return_this() {
    DoubleAssert returned = assertions.doesNotSatisfy(condition);
