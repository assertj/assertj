 ...
 * @author Alex Ruiz
 */
public class LongArrayAssert_contains_Test extends LongArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContains(getInfo(assertions), getActual(assertions), array(6L, 8L));
  }
}
