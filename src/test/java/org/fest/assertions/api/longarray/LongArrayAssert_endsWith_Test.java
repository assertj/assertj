 ...
 * @author Alex Ruiz
 */
public class LongArrayAssert_endsWith_Test extends LongArrayAssertTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertEndsWith(getInfo(assertions), getActual(assertions), array(6L, 8L));
  }
}
