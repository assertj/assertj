...
public class FloatArrayAssert_containsSequence_Test {
  ...
  public void should_verify_that_actual_contains_sequence() {
    assertions.containsSequence(6f, 8f);
    verify(arrays).assertContainsSequence(assertions.info, assertions.actual, array(6f, 8f));
  }

  @Test
  public void should_return_this() {
    FloatArrayAssert returned = assertions.containsSequence(8f);
