...
/**
 * Tests for <code>{@link GenericAssert#as(String)}</code>.
 *
 * @author Alex Ruiz
 */
public class GenericAssert_as_with_text_description_Test {
  ...
  @Test public void should_return_this() {
    ConcreteGenericAssert descriptable = assertions.as(description);
