...
AssertJ's assertions are super easy to use: just type **```assertThat```** followed by the actual value in parentheses and then a dot,
...
A lot of effort have been spent to provide intuitive error messages showing as clearly as possible what the problem is.
