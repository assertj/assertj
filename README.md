...
Special thanks to **Mariusz Smykula**, **Gregor Zeitlinger**, **kju2**, guys from **Pragmatist** : **Tomasz Bartczak** and **Michal Lipski** for their contributions to **assertj-core 1.6.0**.
