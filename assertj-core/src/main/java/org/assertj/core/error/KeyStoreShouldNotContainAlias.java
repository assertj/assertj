...
public class KeyStoreShouldNotContainAlias extends BasicErrorMessageFactory {
  ...
  public KeyStoreShouldNotContainAlias(String alias) {
    super("Expecting KeyStore not to contain alias <%s>, but it did", alias);
  }

  public static KeyStoreShouldNotContainAlias keystoreShouldNotContainAlias(String alias) {
