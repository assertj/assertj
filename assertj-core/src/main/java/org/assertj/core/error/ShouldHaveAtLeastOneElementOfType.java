...
public class ShouldHaveAtLeastOneElementOfType extends BasicErrorMessageFactory {
   ...
   */
  public static ShouldHaveAtLeastOneElementOfType shouldHaveAtLeastOneElementOfType(@Nullable Object actual,
                                                                                    Class<?> expectedType) {
    return new ShouldHaveAtLeastOneElementOfType(actual, expectedType);
  }

  private ShouldHaveAtLeastOneElementOfType(@Nullable Object actual, Class<?> expectedType) {
