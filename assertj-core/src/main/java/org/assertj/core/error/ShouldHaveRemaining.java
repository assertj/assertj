...
/**
 * Creates an error message indicating that buffer's expected number remaining elements and its actual remaining elements
 * do no match.
 *
...
public class ShouldHaveRemaining extends BasicErrorMessageFactory {
   ...
   *
   * @param expected the expected number of remaining elements of the buffer in the failed assertion.
   * @param actual the actual number of remaining elements of the buffer in the failed assertion.
