...
public class ShouldHaveSizeGreaterThanOrEqualTo extends BasicErrorMessageFactory {
   ...
   */
  public static ErrorMessageFactory shouldHaveSizeGreaterThanOrEqualTo(@Nullable Object actual, int actualSize,
                                                                       int expectedMinSize) {
    return new ShouldHaveSizeGreaterThanOrEqualTo(actual, actualSize, expectedMinSize);
  }

  private ShouldHaveSizeGreaterThanOrEqualTo(@Nullable Object actual, int actualSize, int expectedSize) {
