...
public class IntArrays {
   ...
   */
  public void assertHasSizeGreaterThan(AssertionInfo info, int[] actual, int boundary) {
   ...
   */
  public void assertHasSizeGreaterThanOrEqualTo(AssertionInfo info, int[] actual, int boundary) {
   ...
   */
  public void assertHasSizeLessThan(AssertionInfo info, int[] actual, int boundary) {
   ...
   */
  public void assertHasSizeLessThanOrEqualTo(AssertionInfo info, int[] actual, int boundary) {
   ...
   */
  public void assertHasSizeBetween(AssertionInfo info, int[] actual, int lowerBoundary, int higherBoundary) {
   ...
   * @param values the expected values
   */
  public void assertContainsAnyOf(AssertionInfo info, int[] actual, int[] values) {
