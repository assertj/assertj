...
public class IntArrays {
  ...
  /**
   * Creates int array assertions using the given comparison strategy.
   *
   ...
   */
  public void assertNullOrEmpty(AssertionInfo info, int @Nullable [] actual) {
   ...
   */
  public void assertEmpty(AssertionInfo info, int @Nullable [] actual) {
   ...
   */
  public void assertNotEmpty(AssertionInfo info, int @Nullable [] actual) {
   ...
   */
  public void assertHasSize(AssertionInfo info, int @Nullable [] actual, int expectedSize) {
   ...
   */
  public void assertHasSizeGreaterThan(AssertionInfo info, int @Nullable [] actual, int boundary) {
   ...
   */
  public void assertHasSizeGreaterThanOrEqualTo(AssertionInfo info, int @Nullable [] actual, int boundary) {
   ...
   */
  public void assertHasSizeLessThan(AssertionInfo info, int @Nullable [] actual, int boundary) {
   ...
   */
  public void assertHasSizeLessThanOrEqualTo(AssertionInfo info, int @Nullable [] actual, int boundary) {
   ...
   */
  public void assertHasSizeBetween(AssertionInfo info, int @Nullable [] actual, int lowerBoundary, int higherBoundary) {
   ...
   */
  public void assertHasSameSizeAs(AssertionInfo info, int @Nullable [] actual, Iterable<?> other) {
   ...
   * @throws AssertionError if the actual group does not have the same size.
   */
  public void assertHasSameSizeAs(AssertionInfo info, int @Nullable [] actual, Object[] other) {
    arrays.assertHasSameSizeAs(info, actual, other);
  }
   ...
   */
  public void assertContains(AssertionInfo info, int @Nullable [] actual, int[] values) {
   ...
   */
  public void assertContains(AssertionInfo info, int @Nullable [] actual, int value, Index index) {
   ...
   */
  public void assertDoesNotContain(AssertionInfo info, int @Nullable [] actual, int value, Index index) {
   ...
   */
  public void assertContainsOnly(AssertionInfo info, int @Nullable [] actual, int[] values) {
   ...
   */
  public void assertContainsExactly(AssertionInfo info, int @Nullable [] actual, int[] values) {
   ...
   * @param values the expected values
   */
  public void assertContainsExactlyInAnyOrder(AssertionInfo info, int @Nullable [] actual, int[] values) {
   ...
   *           than once values.
   */
  public void assertContainsOnlyOnce(AssertionInfo info, int @Nullable [] actual, int[] values) {
   ...
   */
  public void assertContainsSequence(AssertionInfo info, int @Nullable [] actual, int[] sequence) {
   ...
   */
  public void assertContainsSubsequence(AssertionInfo info, int @Nullable [] actual, int[] subsequence) {
   ...
   */
  public void assertDoesNotContain(AssertionInfo info, int @Nullable [] actual, int[] values) {
   ...
   */
  public void assertDoesNotHaveDuplicates(AssertionInfo info, int @Nullable [] actual) {
   ...
   */
  public void assertStartsWith(AssertionInfo info, int @Nullable [] actual, int[] sequence) {
   ...
   */
  public void assertEndsWith(AssertionInfo info, int @Nullable [] actual, int[] sequence) {
   ...
   * @param actual the given array.
   */
  public void assertIsSorted(AssertionInfo info, int @Nullable [] actual) {
   ...
   */
  public void assertIsSortedAccordingToComparator(AssertionInfo info, int @Nullable [] actual,
   ...
   * @param values the expected values
   */
  public void assertContainsAnyOf(AssertionInfo info, int @Nullable [] actual, int[] values) {
