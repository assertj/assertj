...
public class Long2DArrays {
   ...
   */
  public void assertHasDimensions(AssertionInfo info, long[] @Nullable [] actual, int expectedFirstDimension,
   ...
   */
  public void assertHasSameDimensionsAs(AssertionInfo info, long[] @Nullable [] actual, @Nullable Object other) {
   ...
   */
  public void assertNumberOfRows(AssertionInfo info, long[] @Nullable [] actual, int expectedNumberOfRows) {
