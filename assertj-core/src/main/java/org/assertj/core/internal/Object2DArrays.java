...
public class Object2DArrays<ELEMENT> {
   ...
   */
  public void assertNullOrEmpty(AssertionInfo info, ELEMENT[] @Nullable [] actual) {
   ...
   */
  public void assertEmpty(AssertionInfo info, ELEMENT[] @Nullable [] actual) {
   ...
   */
  public void assertNotEmpty(AssertionInfo info, ELEMENT[] @Nullable [] actual) {
   ...
   */
  public void assertHasDimensions(AssertionInfo info, ELEMENT[] @Nullable [] actual, int expectedFirstDimension,
   ...
   */
  public void assertHasSameDimensionsAs(AssertionInfo info, ELEMENT[] @Nullable [] actual, @Nullable Object other) {
   ...
   */
  public void assertNumberOfRows(AssertionInfo info, ELEMENT[] @Nullable [] actual, int expectedNumberOfRows) {
   ...
   */
  public void assertContains(AssertionInfo info, ELEMENT[] @Nullable [] actual, ELEMENT[] value, Index index) {
   ...
   */
  public void assertDoesNotContain(AssertionInfo info, ELEMENT[] @Nullable [] actual, ELEMENT[] value, Index index) {
