...
public class Double2DArrays {
  ...
  /** Creates assertions for two-dimensional double arrays. */
  public Double2DArrays() {}
   ...
   */
  public void assertHasDimensions(AssertionInfo info, double[] @Nullable [] actual, int expectedFirstDimension,
   ...
   */
  public void assertHasSameDimensionsAs(AssertionInfo info, double[] @Nullable [] actual, @Nullable Object other) {
   ...
   */
  public void assertNumberOfRows(AssertionInfo info, double[] @Nullable [] actual, int expectedNumberOfRows) {
