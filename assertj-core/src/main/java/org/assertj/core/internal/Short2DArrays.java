...
public class Short2DArrays {
  ...
  /** Creates reusable two-dimensional short array assertions. */
   ...
   */
  public void assertHasDimensions(AssertionInfo info, short[] @Nullable [] actual, int expectedFirstDimensionSize,
   ...
   */
  public void assertHasSameDimensionsAs(AssertionInfo info, short[] @Nullable [] actual, @Nullable Object other) {
   ...
   */
  public void assertNumberOfRows(AssertionInfo info, short[] @Nullable [] actual, int expectedNumberOfRows) {
