...
public class Int2DArrays {
   ...
   */
  public void assertHasDimensions(AssertionInfo info, int[] @Nullable [] actual, int expectedFirstDimension,
   ...
   */
  public void assertHasSameDimensionsAs(AssertionInfo info, int[] @Nullable [] actual, @Nullable Object other) {
   ...
   */
  public void assertNumberOfRows(AssertionInfo info, int[] @Nullable [] actual, int expectedNumberOfRows) {
