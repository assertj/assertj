...
public class Char2DArrays {
   ...
   */
  public void assertHasDimensions(AssertionInfo info, char[] @Nullable [] actual, int expectedFirstDimension,
   ...
   */
  public void assertHasSameDimensionsAs(AssertionInfo info, char[] @Nullable [] actual, @Nullable Object other) {
   ...
   */
  public void assertNumberOfRows(AssertionInfo info, char[] @Nullable [] actual, int expectedNumberOfRows) {
