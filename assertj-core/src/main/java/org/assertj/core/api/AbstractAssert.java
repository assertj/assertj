...
public abstract class AbstractAssert<SELF extends AbstractAssert<SELF, ACTUAL>, ACTUAL> implements Assert<SELF, ACTUAL> {
  ...
  @Override
  @CheckReturnValue
  public SELF usingEquals(BiPredicate<? super ACTUAL, ? super ACTUAL> predicate, String customComparatorDescription) {
    return usingComparator((o1, o2) -> predicate.test(o1, o2) ? 0 : -1, customComparatorDescription);
  }
