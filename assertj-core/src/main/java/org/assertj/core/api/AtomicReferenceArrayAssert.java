...
public class AtomicReferenceArrayAssert<T>
   ...
   * <pre><code class='java'> AtomicReferenceArray&lt;String&gt; emptyArray  = new AtomicReferenceArray&lt;&gt;(new String[0]);
   ...
   * <pre><code class='java'> AtomicReferenceArray&lt;String&gt; emptyArray  = new AtomicReferenceArray&lt;&gt;(new String[0]);
   * // assertion fails, it would be confusing if it succeeded as it actually does not perform any check.
   * assertThat(emptyArray).allMatch(s -&gt; s.contains(“error”), "has error")
