 ...
 * if you forget to call {@code assertAll()}  at the end of your test, the test <strong>will pass</strong> even if any assertion
 * objects threw exceptions (because they're proxied, remember?). So don't forget. You can use
 * {@link AutoCloseableSoftAssertions} to make sure {@code assertAll()} is called automatically.
 * </p>
 *
 * <p>
...
public class SoftAssertions extends AbstractSoftAssertions implements StandardSoftAssertionsProvider {
  ...
  /** Creates a soft assertions instance. */
