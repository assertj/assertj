 ...
 */
public class AutoCloseableBDDSoftAssertions extends BDDSoftAssertions implements AutoCloseableSoftAssertionsProvider {

  /** Creates a new auto-closeable BDD soft assertions instance. */
