...
final class ComparingRegularProperties implements RecursiveComparisonIntrospectionStrategy {
  ...
  public Set<String> getChildrenNodeNamesOf(Object node) {
    return node != null
        ? propertiesNamesPerClass.computeIfAbsent(node.getClass(), ComparingRegularProperties::getPropertiesNamesOf)
        : new HashSet<>();
  }
  ...
  private static Set<Method> gettersIncludingInheritedOf(Class<?> clazz) {
