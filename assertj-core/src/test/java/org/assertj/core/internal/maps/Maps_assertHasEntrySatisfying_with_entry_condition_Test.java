...
class Maps_assertHasEntrySatisfying_with_entry_condition_Test extends MapsBaseTest {
  ...
  void should_fail_if_actual_is_null() {
    assertThatExceptionOfType(AssertionError.class).isThrownBy(() -> maps.assertHasEntrySatisfying(INFO, null,
                                                                                                   greenColorCondition))
  ...
  void should_fail_if_actual_does_not_contain_any_entry_matching_the_given_condition() {
    // WHEN
    expectAssertionError(() -> maps.assertHasEntrySatisfying(INFO, actual, blackColorCondition));
    // THEN
  ...
  void should_pass_if_actual_contains_an_entry_matching_the_given_condition() {
    maps.assertHasEntrySatisfying(INFO, actual, greenColorCondition);
  }
}
