...
class RecursiveComparisonAssert_isNotEqualTo_Test extends RecursiveComparisonAssert_isNotEqualTo_BaseTest {
  ...
  @Test
  @SuppressWarnings("AssertBetweenInconvertibleTypes")
  void should_pass_using_a_BiComparator_to_compare_fields_with_different_types_and_different_values() {
    // GIVEN
    TimeOffset actual = new TimeOffset();
    actual.time = LocalTime.now();
    TimeOffsetDto expected = new TimeOffsetDto();
    ...
    // WHEN
    assertThat(actual).usingRecursiveComparison()
                      .withComparatorForTypes((t, s) -> LocalTime.parse(s).compareTo(t), LocalTime.class, String.class)
                      // THEN
                      .isNotEqualTo(expected);
  }
  ...
  @Test
  @SuppressWarnings("AssertBetweenInconvertibleTypes")
  void should_pass_using_a_never_match_BiComparator_to_compare_fields_with_different_types() {
    // GIVEN
    TimeOffset actual = new TimeOffset();
    actual.time = LocalTime.now();
    TimeOffsetDto expected = new TimeOffsetDto();
    ...
    // WHEN
    assertThat(actual).usingRecursiveComparison()
                      .withComparatorForTypes(NEVER_EQUALS::compare, LocalTime.class, String.class)
                      // THEN
                      .isNotEqualTo(expected);
  }
  ...
  @Test
  @SuppressWarnings("AssertBetweenInconvertibleTypes")
  void should_pass_using_at_least_one_BiComparator_that_not_match_to_compare_fields_with_different_types() {
    // GIVEN
    TimeOffset actual = new TimeOffset();
    actual.time = LocalTime.now();
    actual.offset = ZoneOffset.UTC;
    ...
    // WHEN
    assertThat(actual).usingRecursiveComparison()
                      .withComparatorForTypes((z, s) -> ZoneOffset.of(s).compareTo(z), ZoneOffset.class, String.class)
                      .withComparatorForTypes(NEVER_EQUALS::compare, LocalTime.class, String.class)
                      // THEN
                      .isNotEqualTo(expected);
  }
  ...
  @Test
  @SuppressWarnings("AssertBetweenInconvertibleTypes")
  void should_pass_having_two_BiComparators_with_same_left_type_and_one_not_match_to_compare_fields_with_different_types() {
    // GIVEN
    LocalTime now = LocalTime.now();
    TimeOffsetDto actual = new TimeOffsetDto();
    actual.time = now.toString();
    ...
    // WHEN
    assertThat(actual).usingRecursiveComparison()
                      .withComparatorForTypes((s, z) -> ZoneOffset.of(s).compareTo(z), String.class, ZoneOffset.class)
                      .withComparatorForTypes(NEVER_EQUALS::compare, String.class, LocalTime.class)
                      // THEN
                      .isNotEqualTo(expected);
  }
