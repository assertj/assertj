 ...
 */
class ShortArrayAssert_usingComparator_Test {

  @Test
  public void should_set_comparator() {
    // GIVEN
    ...
    // THEN
    Comparator<?> assertionComparator = EXTRACTION.fieldValue("objects.comparisonStrategy.comparator", Comparator.class,
                                                              assertions);
