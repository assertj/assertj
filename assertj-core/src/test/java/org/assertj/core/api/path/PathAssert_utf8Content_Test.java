...
class PathAssert_utf8Content_Test extends PathAssertBaseTest
    implements NavigationMethodWithComparatorBaseTest<PathAssert> {

  @Override
  protected PathAssert invoke_api_method() {
    assertions.utf8Content();
    return assertions;
  }
  ...
  @Test
  public void should_return_StringAssert_on_path_content_decoded_with_utf8() {
    // GIVEN
    Path path = resourcePath("utf8.txt");
    // WHEN
    AbstractStringAssert<?> stringAssert = assertThat(path).utf8Content();
    // THEN
