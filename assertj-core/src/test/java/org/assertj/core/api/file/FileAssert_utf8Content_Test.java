...
class FileAssert_utf8Content_Test extends FileAssertBaseTest
    implements NavigationMethodWithComparatorBaseTest<FileAssert> {
  ...
  @Test
  public void should_return_StringAssert_on_file_content_decoded_with_utf8() {
    // GIVEN
    File file = resourceFile("utf8.txt");
    // WHEN
    AbstractStringAssert<?> stringAssert = assertThat(file).utf8Content();
    // THEN
