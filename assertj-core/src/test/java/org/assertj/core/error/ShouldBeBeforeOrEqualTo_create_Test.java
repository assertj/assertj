...
class ShouldBeBeforeOrEqualTo_create_Test {
  ...
  void should_create_error_message() {
    // GIVEN
    ErrorMessageFactory factory = shouldBeBeforeOrEqualTo(parseDate("2019-01-01"), parseDate("2012-01-01"));
    // WHEN
  ...
  void should_create_error_message_with_comparison_strategy() {
    ...
    ErrorMessageFactory factory = shouldBeBeforeOrEqualTo(parseDate("2019-01-01"), parseDate("2012-01-01"), comparisonStrategy);
    // WHEN
    String message = factory.create(new TextDescription("Test"), STANDARD_REPRESENTATION);
    // THEN
