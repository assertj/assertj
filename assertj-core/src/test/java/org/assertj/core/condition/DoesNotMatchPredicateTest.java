...
class DoesNotMatchPredicateTest implements WithAssertions {
  ...
  void should_not_match_predicate_with_description_() {
    assertThat(yoda).doesNotMatch(x -> x.lightSaberColor.equals("Red"), "does not have red light saber");
  }

  @Test
  void should_fail_if_object_matches_predicate() {
    assertThatExceptionOfType(AssertionError.class).isThrownBy(() -> assertThat(yoda).doesNotMatch(x -> x.lightSaberColor.equals("Green")))
  ...
  void should_fail_if_given_predicate_description_is_null() {
    assertThatNullPointerException().isThrownBy(() -> assertThat(yoda).doesNotMatch(x -> x.lightSaberColor.equals("Green"),
                                                                                    null))
